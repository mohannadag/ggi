        ...
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="max-w-[600px]  mx-auto text-center text-white relative z-[1]">
                    ...
                    <h1 class="font-lora text-[36px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl font-medium"><?php echo e($property->property_id); ?></h1>
        ...
        <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
            <div class="col-span-12 md:col-span-9 lg:col-span-9 mb-[30px]">
                <div class="col-span-12 flex flex-wrap flex-col md:flex-row items-start justify-between">
                    <div class="mb-5 lg:mb-0">
                        <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize lg font-medium"><?php echo e($property->property_id); ?><span class="text-secondary">.</span></h2>
                    </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="<?php echo e(URL::asset('/images/thumbnail/' . $property->thumbnail)); ?>" class="gallery-image">
                                        <img class="object-cover rounded-[8px] w-full h-full" src="<?php echo e(URL::asset('/images/thumbnail/' . $property->thumbnail)); ?>" alt="gallery image" loading="lazy" width="770" height="465">
                                    </a>
                                </div>
                                <?php if($pic): ?>
                                ...
                                <div class="swiper-slide">
                                    <a href="<?php echo e(URL::asset('images/gallery/' . $p)); ?>" class="gallery-image">
                                        <img class="object-cover rounded-[8px] w-full h-full" src="<?php echo e(URL::asset('images/gallery/' . $p)); ?>" alt="gallery image" loading="lazy" width="770" height="465">
                                    </a>
                                </div>
                ...
                <div class="mt-[45px] mb-[35px]">
                    ...
                    <div>
                        <dl class="mt-5 text-center grid grid-cols-3 gap-4 sm:grid-cols-3">
                            <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-2">
                                <dt class="truncate text-sm font-medium text-gray-500"><?php echo e(trans('file.city')); ?></dt>
                                <dd class="mt-1 font-semibold tracking-tight text-gray-900"><?php echo e($property->state->stateTranslation->name ?? ($property->state->stateTranslationEnglish->name ?? null)); ?></dd>
                            </div>

                            <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-2">
                                <dt class="truncate text-sm font-medium text-gray-500"><?php echo e(trans('file.state_area')); ?></dt>
                                <dd class="mt-1 font-semibold tracking-tight text-gray-900"> <?php echo e($property->city->cityTranslation->name ?? ($property->city->cityTranslationEnglish->name ?? null)); ?></dd>
                            </div>

                            <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-2">
                                <dt class="truncate text-sm font-medium text-gray-500"><?php echo e(trans('file.property_type')); ?></dt>
                                <dd class="mt-1 font-semibold tracking-tight text-gray-900"><?php echo e($property->category->categoryTranslation->name); ?></dd>
                            </div>
                            <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-2">
                                <dt class="truncate text-sm font-medium text-gray-500"><?php echo e(trans('file.status')); ?></dt>
                                <?php if($property->propertyDetails->deliver_year <= '2022'): ?>
                                <dd class="mt-1 font-semibold tracking-tight text-gray-900"><?php echo e(trans('file.ready_project')); ?></dd>
                                <?php elseif($property->propertyDetails->deliver_year >= '2023'): ?>
                                <dd class="mt-1 font-semibold tracking-tight text-gray-900"><?php echo e(trans('file.under_construction')); ?></dd>
                                <?php endif; ?>
                            </div>
                            <?php if($property->propertyDetails->deliver_year !== ''): ?>
                            <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-2">
                                <dt class="truncate text-sm font-medium text-gray-500"><?php echo e(trans('file.construction_year')); ?></dt>
                                <dd class="mt-1 font-semibold tracking-tight text-gray-900"><?php echo e($property->propertyDetails->deliver_year); ?></dd>
                            </div>
                            <?php endif; ?>
                        </dl>
                    </div>
                    ...
                    <h4 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium"> <?php echo e(trans('file.features')); ?><span class="text-secondary">.</span>
                    </h4>
                    <ul class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 px-[15px] mx-[-15px] mt-[40px]">
                        <?php if($property->propertyDetails->heating == 2): ?>
                        <li class="flex flex-wrap items-center mb-[25px]">
                            <img class="mr-[15px]" src="<?php echo e(url('frontend/images/interior/heating.png')); ?>" loading="lazy" alt="icon" width="30" height="20">
                            &nbsp; <span><?php echo e(trans('file.central_heating')); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if($property->propertyDetails->heating == 3): ?>
                        <li class="flex flex-wrap items-center mb-[25px]">
                            <img class="mr-[15px]" src="<?php echo e(url('frontend/images/interior/heating.png')); ?>" loading="lazy" alt="icon" width="30" height="20">
                            &nbsp;<span><?php echo e(trans('file.natural_gas')); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if($property->propertyDetails->view == "2"): ?>
                        <li class="flex flex-wrap items-center mb-[25px]">
                            <img class="mr-[15px]" src="<?php echo e(url('frontend/images/interior/view.png')); ?>" loading="lazy" alt="icon" width="30" height="20">
                            &nbsp;<span><?php echo e(trans('file.view_sea')); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if($property->propertyDetails->view == "3"): ?>
                        <li class="flex flex-wrap items-center mb-[25px]">
                            <img class="mr-[15px]" src="<?php echo e(url('frontend/images/interior/view.png')); ?>" loading="lazy" alt="icon" width="30" height="20">
                            &nbsp;<span><?php echo e(trans('file.view_forest')); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if($property->propertyDetails->view == "4"): ?>
                        <li class="flex flex-wrap items-center mb-[25px]">
                            <img class="mr-[15px]" src="<?php echo e(url('frontend/images/interior/view.png')); ?>" loading="lazy" alt="icon" width="30" height="20">
                            &nbsp;<span><?php echo e(trans('file.view_street')); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if($property->propertyDetails->view == "5"): ?>
                        <li class="flex flex-wrap items-center mb-[25px]">
                            <img class="mr-[15px]" src="<?php echo e(url('frontend/images/interior/view.png')); ?>" loading="lazy" alt="icon" width="30" height="20">
                            &nbsp;<span><?php echo e(trans('file.view_landscape')); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if($property->propertyDetails->title_deed_type == "1"): ?>
                        <li class="flex flex-wrap items-center mb-[25px]">
                            <img class="mr-[15px]" src="<?php echo e(url('frontend/images/interior/titledeed.png')); ?>" loading="lazy" alt="icon" width="30" height="20">
                            &nbsp;<span><?php echo e(trans('file.ready_title')); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if($property->propertyDetails->deliver_year <= 2023): ?> <li class="flex flex-wrap items-center mb-[25px]">
                            <img class="mr-[15px]" src="<?php echo e(url('frontend/images/interior/ready.png')); ?>" loading="lazy" alt="icon" width="30" height="20">
                            &nbsp;<span><?php echo e(trans('file.ready_project')); ?></span>
                            </li>
                            <?php elseif($property->propertyDetails->deliver_year >= 2023): ?>
                            <li class="flex flex-wrap items-center mb-[25px]">
                                <img class="mr-[15px]" src="<?php echo e(url('frontend/images/interior/construction.png')); ?>" loading="lazy" alt="icon" width="30" height="20">
                                &nbsp;<span><?php echo e(trans('file.under_construction')); ?></span>
                            </li>
                            <?php endif; ?>
                    </ul>
                    <?php endif; ?>
                    <h5 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium"><?php echo e(trans('file.project_details')); ?><span class="text-secondary">?</span></h5>
                    <?php echo $property->propertyDetails->propertyDetailTranslation->content ?? ($property->propertyDetails->propertyDetailTranslationEnglish->content ?? null); ?>

                </div>
                <?php if($property->propertyDetails->video !== Null): ?>
                <div class="w-auto h-auto">
                    <div class="mt-[25px] mb-[35px]">
                        <h5 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium"><?php echo e(trans('file.video')); ?><span class="text-secondary">.</span></h5>
                        <div class="relative">
                            <div data-relative-input="true">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if($property->propertyDetails->first_floor_sold == 2): ?>

                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-large text-gray-900"><s><?php echo e($property->propertyDetails->first_floor_title); ?></s> <span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span>
                                        </td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                               <s> <?php echo e($property->propertyDetails->first_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->first_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->first_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->first_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->second_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->second_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                               <s> <?php echo e($property->propertyDetails->second_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->second_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->second_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                               <s> <?php echo e(currencyConvert($property->propertyDetails->second_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->third_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->third_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->third_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->third_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->third_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->third_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->fourth_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->fourth_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                               <s> <?php echo e($property->propertyDetails->fourth_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->fourth_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->fourth_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->fourth_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->fifth_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->fifth_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->fifth_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->fifth_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->fifth_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->fifth_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->sixth_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->sixth_floor_title); ?></s></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->sixth_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->sixth_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->sixth_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->sixth_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->seventh_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"> <s><?php echo e($property->propertyDetails->seventh_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->seventh_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->seventh_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->seventh_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->seventh_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->eighth_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->eighth_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->eighth_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->eighth_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->eighth_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->eighth_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->ninth_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->ninth_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->ninth_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->ninth_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->ninth_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->ninth_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->tenth_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->tenth_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->tenth_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->tenth_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->tenth_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->tenth_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->eleventh_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->eleventh_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->eleventh_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->eleventh_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->eleventh_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->eleventh_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                        ...
                                        <?php if($property->propertyDetails->twelfth_floor_sold == 2): ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                                            <td class="px-6 py-4 whitespace-nowrap text-base font-medium text-gray-900"><s><?php echo e($property->propertyDetails->twelfth_floor_title); ?></s><span class="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-white"><?php echo e(trans('file.sold')); ?></span></td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->twelfth_floor_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e($property->propertyDetails->twelfth_floor_max_size); ?> <?php echo e(trans('file.sq-ft')); ?></s>
                                            </td> -->
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->twelfth_floor_price)); ?></s>
                                            </td>
                                            <!-- <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <s><?php echo e(currencyConvert($property->propertyDetails->twelfth_floor_max_price)); ?></s>
                                            </td> -->
                                        </tr>
                                        <?php else: ?>
                                        <tr class="border-b bg-[#E9F1FF]">
                ...
                <?php endif; ?>
                <?php if($property->propertyDetails->location_info !== NULL): ?>
                <h5 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium"><?php echo e(trans('file.location_info')); ?><span class="text-secondary">.</span></h5>
                <?php endif; ?>
                <?php echo $property->propertyDetails->propertyDetailTranslation->location_info ?? ($property->propertyDetails->propertyDetailTranslationEnglish->location_info ?? null); ?>
            ...
            <div class="col-span-12 md:col-span-3 lg:col-span-3 mb-[30px]">
                <aside class="mb-[-60px] asidebar">
                    <div class="mb-[60px]">
                        <h3 class="text-primary leading-none text-[24px] font-lora mb-[40px] font-medium"><?php echo e(trans('file.get_touch')); ?><span class="text-secondary">!</span></h3>
                        ...
                        <form id="SubmitFormAgent" class="relative">
                            ...
                            <div class="mb-6">
                                <textarea type="text" rows="2" id="send-message" name="message" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="<?php echo e(trans('file.message')); ?>" required></textarea>
                            </div>
                            <div class="flex items-center mb-4">
                                <label for="checkbox-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(trans('file.by_submitting')); ?> <a href="<?php echo e(URL::asset('/terms')); ?>" class="text-blue-600 hover:underline dark:text-blue-500"><?php echo e(trans('file.terms')); ?></a>.</label>
                            </div>

                            <button type="submit" class="block z-[1] before:rounded-md before:block before:absolute before:left-auto before:right-0 before:inset-y-0 before:z-[-1] before:bg-secondary before:w-0 hover:before:w-full hover:before:left-0 hover:before:right-auto before:transition-all leading-none px-[30px] py-[12px] capitalize font-medium text-white text-[14px] xl:text-[16px] relative after:block after:absolute after:inset-0 after:z-[-2] after:bg-primary after:rounded-md after:transition-all"><?php echo e(trans('file.submit')); ?></button>
                        </form>
                    </div>

                    <div class="mb-[60px]">
                        <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[40px] font-medium"><?php echo e(trans('file.similar_listing')); ?><span class="text-secondary">.</span></h3>
                        <div class="sidebar-carousel relative">
                            <div class="swiper p-1">
                                <!-- Additional required wrapper -->
                                <div class="swiper-wrapper">
                                    <!-- Slides -->
                                    <?php $__currentLoopData = $properties->where('moderation_status', 1)->shuffle(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $similarListing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($property->city_id == $similarListing->city_id): ?>
                                    <div class="swiper-slide">
                                        <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_3px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center">
                                            <div class="relative">
                                                <a href="<?php echo e(route('front.property', ['property' => $similarListing->id])); ?>" class="block">
                                                    <img src="<?php echo e(URL::asset('/images/thumbnail/' . $similarListing->thumbnail)); ?>" class="w-full h-full" loading="lazy" width="370" height="266" alt="@title">
                                                </a>
                                            </div>

                                            <div class="pt-[15px] pb-[20px] px-[20px] text-<?php echo e(App::isLocale('ar') ? 'right' : 'left'); ?>">
                                                <h3><a href="<?php echo e(route('front.property', ['property' => $similarListing->id])); ?>" class="font-lora leading-tight text-[18px] text-primary"><?php echo e($similarListing->property_id); ?></a></h3>
                                                <h4 class="leading-none"><a href="<?php echo e(route('front.property', ['property' => $similarListing->id])); ?>" class="font-light text-[14px] leading-[1.75] text-primary underline"><?php echo e($similarListing->country->countryTranslation->name ?? ($similarListing->country->countryTranslationEnglish->name ?? null)); ?>,
                                                        <?php echo e($similarListing->state->stateTranslation->name ?? ($similarListing->state->stateTranslationEnglish->name ?? null)); ?>,
                                                        <?php echo e($similarListing->city->cityTranslation->name ?? ($similarListing->city->cityTranslationEnglish->name ?? null)); ?></a></h4>
                                                <ul class="mt-[10px]">
                    ...
                    <div class="mb-[60px]">
                        <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[40px] font-medium">
                            <?php echo e(trans('file.tags')); ?><span class="text-secondary">.</span>
                        </h3>
                        <ul class="flex flex-wrap my-[-7px] mx-[-5px] font-light text-[12px]">
                        <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="my-[7px] mx-[5px]"><a href="<?php echo e(route('tags',$tag)); ?>" class="leading-none border border-[#E0E0E0] py-[8px] px-[10px] block rounded-[4px] hover:text-secondary"><?php echo e($tag->tagTranslation->name ?? $tag->tagTranslationEnglish->name  ?? null); ?></a>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
...
<?php echo $__env->make('frontend.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/property.blade.php ENDPATH**/ ?>