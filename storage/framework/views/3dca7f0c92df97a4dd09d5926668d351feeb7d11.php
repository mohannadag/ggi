...
<section class="bg-no-repeat bg-center bg-cover bg-[#FFF6F0] h-[350px] lg:h-[513px] flex flex-wrap items-center relative before:absolute before:inset-0 before:content-['']" style="background-image: url('<?php echo e(url('frontend/images/breadcrumb/properties-bg.jpg')); ?>');">
    <div class="container">
                                    ...
                                    <ul class="flex flex-nowrap items-center bg-[#F4F4F4] w-full mt-5">
                                        ...
                                        <li class="flex flex-wrap items-center 2xl:px-[35px] xl:px-[20px] sm:px-[40px] md:px-[15px] px-[15px] py-2">
                                            <svg class="mr-[5px]" width="14" height="14" viewBox="0 0 14 14" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M2.625 8.96875H4.8125V9.84375H2.625V8.96875Z" />
                                                <path d="M9.1875 8.96875H11.375V9.84375H9.1875V8.96875Z" />
                                                <path d="M7 0.403564L0.4375 3.03849V3.98139L7 1.34649L13.5625 3.98139V3.03849L7 0.403564Z" fill="#494949" />
                                            </svg>
                                            <span>2</span>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_3px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center">
                                            ...
                                            <div class="pt-[15px] pb-[20px] px-[20px] text-<?php echo e(App::isLocale('ar') ? 'right' : 'left'); ?>">
                                                ...
                                                <ul class="mt-[10px]">
                                                    <li class="flex flex-wrap items-center justify-between">
                                                        <span class="font-lora text-[14px] text-secondary leading-none"><?php echo e(trans('file.starts_from')); ?>: <?php echo e(currencyConvert($property->price)); ?></span>
