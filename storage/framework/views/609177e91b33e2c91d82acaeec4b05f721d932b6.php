        ...
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="text-center text-white relative">
                    <div class="mb-5"><span class="text-base block"><?php echo e($tag->tagTranslation->name); ?></span></div>
...
<div class="ps-page ps-page--blog">
    ...
    <section class="popular-properties py-[80px] lg:py-[120px]">
        <div class="container">
            ...
            <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
                ...
                <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[30px] font-medium"><?php echo e(trans('file.realted_properties')); ?><span class="text-secondary">.</span></h3>
                    <div class="grid sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-[30px]">
                        ...
                        <div class="swiper-slide">
                            <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                <div class="relative">
                                    <a href="<?php echo e(route('front.property', ['property' => $property->id])); ?>" class="block"><img src="<?php echo e(URL::asset('/images/backgroundImage/'.$property->background_image)); ?>" class="w-full h-full" loading="lazy" width="370" height="266" alt="<?php echo e($property->propertyTranslation->title ?? ($property->propertyTranslationEnglish->title ?? null)); ?>"></a>
                                </div>
    ...
    <section class="popular-properties py-[80px] lg:py-[120px]">
        <div class="container">
            <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
                <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[30px] font-medium"><?php echo e(trans('file.related_posts')); ?><span class="text-secondary">.</span></h3>
