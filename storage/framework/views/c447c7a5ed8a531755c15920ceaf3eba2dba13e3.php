...
<section class="popular-properties py-[80px] lg:py-[20px]">
    <div class="container">
            ...
            <div class="col-span-12">
                <div class="flex flex-col items-center justify-center mb-[50px]">
                    ...
                    <h2 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium">
                        <?php echo e(trans('file.featured_properties')); ?><span class="text-secondary">.</span></h2>
                </div>
            </div>
        </div>
        ...
        <div class="properties-slider">
            <div class="swiper  -mx-[15px] -my-[60px] px-[15px] py-[60px]">
                <div class="swiper-wrapper">
                    <!-- swiper-slide start -->
                    <?php $__currentLoopData = $properties->take(10)->where('is_featured', 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/includes/popular-properties.blade.php ENDPATH**/ ?>