...
<?php echo $__env->make('frontend.includes.header1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <!-- Hero section start -->
        <section class="bg-no-repeat bg-center bg-cover bg-[#FFF6F0] h-[350px] lg:h-[513px] flex flex-wrap items-center relative before:absolute before:inset-0 before:content-['']" style="background-image: url('<?php echo e(URL::asset('/images/images/'.$page->file)); ?>');">
            <div class="container">
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div class="text-center text-primary relative">
                            <h1 class="font-lora text-[36px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl font-medium"><?php echo e($page->pageTranslation->title ?? ($page->pageTranslationEnglish->title ?? null)); ?></h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
                    <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                        ...
                        <div class="mt-[55px] mb-[35px]">
                            <h2 class="font-lora leading-tight text-[22px] md:text-[28px] lg:text-[32px] text-primary mb-[10px] font-medium"> <?php echo e($page->pageTranslation->title ?? ($page->pageTranslationEnglish->title ?? null)); ?></h2>

                            <p class="max-w-[767px]"><?php echo $page->pageTranslation->content ?? ($page->pageTranslationEnglish->content ?? null); ?></p>
                        </div>
                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-[30px]">
                        <aside class="mb-[-40px]">
                            ...
                            <div class="mb-[40px] flex flex-col">
                                <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[30px] font-medium"><?php echo e(trans('file.get_touch')); ?><span class="text-secondary">.</span></h3>
...
<?php echo $__env->make('frontend.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/page.blade.php ENDPATH**/ ?>