                        ...
                        <div class="grid grid-cols-1 gap-[30px]">
                            ...
                            <div
                                ...
                                <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                    ...
                                    <span
                                        class="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-primary leading-none text-[14px] font-normal">for
                                        Sale</span>
                                ...
                                <div class="flex flex-col relative w-full lg:w-[calc(100%-300px)]">
                                    ...
                                    <ul class="flex flex-nowrap items-center bg-[#F4F4F4] w-full mt-5">
                                        <li
                                            class="flex flex-wrap items-center 2xl:px-[35px] xl:px-[20px] sm:px-[40px] md:px-[15px] px-[15px] py-2 border-r border-[#E0DEDE]">
                                            <svg class="mr-[5px]" width="14" height="14" viewBox="0 0 14 14"
                                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11.8125 9.68709V4.31285C12.111 4.23634 12.384 4.0822 12.6037 3.86607C12.8234 3.64994 12.982 3.37951 13.0634 3.08226C13.1448 2.78501 13.1461 2.47151 13.0671 2.1736C12.9882 1.87569 12.8318 1.60398 12.6139 1.38605C12.396 1.16812 12.1243 1.01174 11.8263 0.932792C11.5284 0.85384 11.2149 0.855126 10.9177 0.936521C10.6204 1.01792 10.35 1.17652 10.1339 1.39623C9.91774 1.61593 9.7636 1.88892 9.68709 2.18747H4.31285C4.23634 1.88892 4.0822 1.61593 3.86607 1.39623C3.64994 1.17652 3.37951 1.01792 3.08226 0.936521C2.78501 0.855126 2.47151 0.85384 2.1736 0.932792C1.87569 1.01174 1.60398 1.16812 1.38605 1.38605C1.16812 1.60398 1.01174 1.87569 0.932792 2.1736C0.85384 2.47151 0.855126 2.78501 0.936521 3.08226C1.01792 3.37951 1.17652 3.64994 1.39623 3.86607C1.61593 4.0822 1.88892 4.23634 2.18747 4.31285V9.68709C1.88892 9.7636 1.61593 9.91774 1.39623 10.1339C1.17652 10.35 1.01792 10.6204 0.936521 10.9177C0.855126 11.2149 0.85384 11.5284 0.932792 11.8263C1.01174 12.1243 1.16812 12.396 1.38605 12.6139C1.60398 12.8318 1.87569 12.9882 2.1736 13.0671C2.47151 13.1461 2.78501 13.1448 3.08226 13.0634C3.37951 12.982 3.64994 12.8234 3.86607 12.6037C4.0822 12.384 4.23634 12.111 4.31285 11.8125H9.68709C9.7636 12.111 9.91774 12.384 10.1339 12.6037C10.35 12.8234 10.6204 12.982 10.9177 13.0634C11.2149 13.1448 11.5284 13.1461 11.8263 13.0671C12.1243 12.9882 12.396 12.8318 12.6139 12.6139C12.8318 12.396 12.9882 12.1243 13.0671 11.8263C13.1461 11.5284 13.1448 11.2149 13.0634 10.9177C12.982 10.6204 12.8234 10.35 12.6037 10.1339C12.384 9.91774 12.111 9.7636 11.8125 9.68709ZM11.375 1.74997C11.548 1.74997 11.7172 1.80129 11.8611 1.89744C12.005 1.99358 12.1171 2.13024 12.1834 2.29012C12.2496 2.45001 12.2669 2.62594 12.2332 2.79568C12.1994 2.96541 12.1161 3.12132 11.9937 3.24369C11.8713 3.36606 11.7154 3.4494 11.5457 3.48316C11.3759 3.51692 11.2 3.49959 11.0401 3.43337C10.8802 3.36714 10.7436 3.25499 10.6474 3.11109C10.5513 2.9672 10.5 2.79803 10.5 2.62497C10.5002 2.39298 10.5925 2.17055 10.7565 2.00651C10.9206 1.84246 11.143 1.7502 11.375 1.74997ZM1.74997 2.62497C1.74997 2.45191 1.80129 2.28274 1.89744 2.13885C1.99358 1.99495 2.13024 1.8828 2.29012 1.81658C2.45001 1.75035 2.62594 1.73302 2.79568 1.76678C2.96541 1.80055 3.12132 1.88388 3.24369 2.00625C3.36606 2.12862 3.4494 2.28453 3.48316 2.45427C3.51692 2.624 3.49959 2.79993 3.43337 2.95982C3.36714 3.1197 3.25499 3.25636 3.11109 3.35251C2.9672 3.44865 2.79803 3.49997 2.62497 3.49997C2.39298 3.49974 2.17055 3.40748 2.00651 3.24343C1.84246 3.07939 1.7502 2.85696 1.74997 2.62497ZM2.62497 12.25C2.45191 12.25 2.28274 12.1987 2.13885 12.1025C1.99495 12.0064 1.8828 11.8697 1.81658 11.7098C1.75035 11.5499 1.73302 11.374 1.76678 11.2043C1.80055 11.0345 1.88388 10.8786 2.00625 10.7563C2.12862 10.6339 2.28453 10.5505 2.45427 10.5168C2.624 10.483 2.79993 10.5003 2.95982 10.5666C3.1197 10.6328 3.25636 10.745 3.35251 10.8888C3.44865 11.0327 3.49997 11.2019 3.49997 11.375C3.49974 11.607 3.40748 11.8294 3.24343 11.9934C3.07939 12.1575 2.85696 12.2497 2.62497 12.25ZM9.68709 10.9375H4.31285C4.23448 10.6367 4.07729 10.3622 3.8575 10.1424C3.63771 9.92265 3.36326 9.76546 3.06247 9.68709V4.31285C3.36324 4.23444 3.63766 4.07724 3.85745 3.85745C4.07724 3.63766 4.23444 3.36324 4.31285 3.06247H9.68709C9.76546 3.36326 9.92265 3.63771 10.1424 3.8575C10.3622 4.07729 10.6367 4.23448 10.9375 4.31285V9.68709C10.6367 9.76542 10.3622 9.92259 10.1424 10.1424C9.92259 10.3622 9.76542 10.6367 9.68709 10.9375ZM11.375 12.25C11.2019 12.25 11.0327 12.1987 10.8888 12.1025C10.745 12.0064 10.6328 11.8697 10.5666 11.7098C10.5003 11.5499 10.483 11.374 10.5168 11.2043C10.5505 11.0345 10.6339 10.8786 10.7563 10.7563C10.8786 10.6339 11.0345 10.5505 11.2043 10.5168C11.374 10.483 11.5499 10.5003 11.7098 10.5666C11.8697 10.6328 12.0064 10.745 12.1025 10.8888C12.1987 11.0327 12.25 11.2019 12.25 11.375C12.2496 11.6069 12.1573 11.8293 11.9933 11.9933C11.8293 12.1573 11.6069 12.2496 11.375 12.25Z"
                                        ...
                                        <li
                                            class="flex flex-wrap items-center 2xl:px-[35px] xl:px-[20px] sm:px-[40px] md:px-[15px] px-[15px] py-2">
                                            <svg class="mr-[5px]" width="14" height="14" viewBox="0 0 14 14"
                                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M12.25 6.98507H12.236L11.1307 4.49805C11.0275 4.26615 10.8592 4.06913 10.6464 3.93083C10.4335 3.79253 10.1851 3.71887 9.93125 3.71875H4.06875C3.81491 3.71888 3.56655 3.79256 3.3537 3.93086C3.14085 4.06916 2.97263 4.26616 2.86937 4.49805L1.76397 6.98507H1.75C1.51802 6.98533 1.29561 7.0776 1.13157 7.24164C0.967531 7.40568 0.875261 7.62809 0.875 7.86007V10.9226C0.875261 11.1546 0.967531 11.377 1.13157 11.541C1.29561 11.705 1.51802 11.7973 1.75 11.7976V12.9062C1.7502 13.0802 1.81941 13.247 1.94243 13.3701C2.06546 13.4931 2.23226 13.5623 2.40625 13.5625H3.9375C4.11149 13.5623 4.27829 13.4931 4.40131 13.3701C4.52434 13.247 4.59355 13.0802 4.59375 12.9062V11.7976H9.40625V12.9062C9.40645 13.0802 9.47566 13.247 9.59869 13.3701C9.72171 13.4931 9.88851 13.5623 10.0625 13.5625H11.5938C11.7677 13.5623 11.9345 13.4931 12.0576 13.3701C12.1806 13.247 12.2498 13.0802 12.25 12.9062V11.7976C12.482 11.7973 12.7044 11.705 12.8684 11.541C13.0325 11.377 13.1247 11.1546 13.125 10.9226V7.86007C13.1247 7.62809 13.0325 7.40568 12.8684 7.24164C12.7044 7.0776 12.482 6.98533 12.25 6.98507ZM3.66885 4.85352C3.70327 4.7762 3.75936 4.71052 3.83033 4.66442C3.90131 4.61831 3.98412 4.59377 4.06875 4.59375H9.93125C10.0159 4.59379 10.0986 4.61835 10.1696 4.66445C10.2406 4.71055 10.2966 4.77622 10.331 4.85352L11.2784 6.98504H2.7215L3.66885 4.85352ZM3.71875 12.6875H2.625V11.7976H3.71875V12.6875ZM11.375 12.6875H10.2812V11.7976H11.375V12.6875ZM12.25 10.9226H1.75V7.86007H12.25V10.9226Z" />
                        ...
                        <form class="relative" action="<?php echo e(route('search.property')); ?>" method="GET">
                            ...
                            <div class="relative mb-[25px] bg-white">
                                ...
                                <select name="state" id="state"
                                    ...
                                    <option value="<?php echo e(old('state', request()->state)); ?>"><?php echo e(DB::table('states')->where('id', old('state', request()->state))->value('name')); ?></option>
                                    <?php else: ?>
                            ...
                            <div class="relative mb-[25px] bg-white">
                                ...
                                <select name="city_id" id="city_id"
                                    ...
                                    <option value="<?php echo e(old('city_id', request()->city_id)); ?>"><?php echo e(DB::table('cities')->where('id', old('city_id', request()->city_id))->value('name')); ?></option>
                                    <?php else: ?>
                            ...
                            <div class="relative mb-[25px] bg-white">
                                ...
                                <select id="category_id" name="category_id"
                                    ...
                                    <option value="<?php echo e(old('category_id', request()->category_id)); ?>"><?php echo e(old('category_id',
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            // console.log(allData);
            if (allData.category_id && allData.city_id === "" && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath ===
                "" && allData.title === "") {
                // console.log(true);
                var api_url1 = window.location.href + '/../../api/properties/search-properties/' + allData
                    .category_id;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/' + allData.category_id;
            }
            if (allData.category_id === "" && allData.city_id && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath ===
                "" && allData.title === "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/cities/' + allData
                    .city_id;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/cities/' + allData.city_id;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice && allData.maxPrice &&
                allData.minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath === "" &&
                allData.title === "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/prices/' + allData
                    .minPrice + '/' + allData.maxPrice;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/prices/' + allData.minPrice + '/' + allData.maxPrice;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice === "" && allData
                .maxPrice === "" && allData.minArea && allData.maxArea && allData.bed === "" && allData.bath ===
                "" && allData.title === "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/areas/' + allData
                    .minArea + '/' + allData.maxArea;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/areas/' + allData.minArea + '/' + allData.maxArea;
            }
            if (allData.category_id && allData.city_id && allData.minPrice === "" && allData.maxPrice === "" &&
                allData.minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath === "" &&
                allData.title === "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/category-city/' +
                    allData.category_id + '/' + allData.city_id;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city/' + allData.category_id + '/' + allData
                    .city_id;
            }

            if (allData.category_id && allData.city_id === "" && allData.minPrice && allData.maxPrice && allData
                .minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath === "" && allData
                .title === "") {
                // console.log(true);
                var api_url1 = window.location.href + '/../../api/properties/search-properties/category-price/' +
                    allData.category_id + '/' + allData.minPrice + '/' + allData.maxPrice;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-price/' + allData.category_id + '/' + allData
                    .minPrice + '/' + allData.maxPrice;
            }
            if (allData.category_id && allData.city_id === "" && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea && allData.maxArea && allData.bed === "" && allData.bath === "" && allData
                .title === "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/category-area/' +
                    allData.category_id + '/' + allData.minArea + '/' + allData.maxArea;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-area/' + allData.category_id + '/' + allData
                    .minArea + '/' + allData.maxArea;
            }
            if (allData.category_id === "" && allData.city_id && allData.minPrice && allData.maxPrice && allData
                .minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath === "" && allData
                .title === "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/city-price/' +
                    allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/city-price/' + allData.city_id + '/' + allData.minPrice +
                    '/' + allData.maxPrice;
            }
            if (allData.category_id === "" && allData.city_id && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea && allData.maxArea && allData.bed === "" && allData.bath === "" && allData
                .title === "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/city-area/' + allData
                    .city_id + '/' + allData.minArea + '/' + allData.maxArea;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/city-area/' + allData.city_id + '/' + allData.minArea +
                    '/' + allData.maxArea;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice && allData.maxPrice &&
                allData.minArea && allData.maxArea && allData.bed === "" && allData.bath === "" && allData.title ===
                "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/price-area/' +
                    allData.minPrice + '/' + allData.maxPrice + '/' + allData.minArea + '/' + allData.maxArea;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/price-area/' + allData.minPrice + '/' + allData.maxPrice +
                    '/' + allData.minArea + '/' + allData.maxArea;
            }
            ...
            if (allData.category_id && allData.city_id && allData.minPrice && allData.maxPrice && allData
                ...
                .title === "") {
                // console.log(true);
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-price/' + allData.category_id + '/' +
                    allData.city_id + '/' + '/' + allData.minPrice + '/' + allData.maxPrice;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-price/' + allData.category_id + '/' +
                    allData.city_id + '/' + '/' + allData.minPrice + '/' + allData.maxPrice;
            ...
            if (allData.category_id && allData.city_id && allData.minPrice === "" && allData.maxPrice === "" &&
                ...
                "") {
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-area/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.minArea + '/' + allData.maxArea;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-area/' + allData.category_id + '/' + allData
                    .city_id + '/' + allData.minArea + '/' + allData.maxArea;
            }
            if (allData.category_id && allData.city_id === "" && allData.minPrice && allData.maxPrice && allData
                .minArea && allData.maxArea && allData.bed === "" && allData.bath === "" && allData.title === "") {
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-price-area/' + allData.category_id + '/' +
                    allData.minPrice + '/' + allData.maxPrice + '/' + allData.minArea + '/' + allData.maxArea;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-price-area/' + allData.category_id + '/' +
                    allData.minPrice + '/' + allData.maxPrice + '/' + allData.minArea + '/' + allData.maxArea;
            ...
            if (allData.category_id === "" && allData.city_id && allData.minPrice && allData.maxPrice && allData
                .minArea && allData.maxArea && allData.bed === "" && allData.bath === "" && allData.title === "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/city-price-area/' +
                    allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' + allData.minArea +
                    '/' + allData.maxArea;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/city-price-area/' + allData.city_id + '/' + allData
                    .minPrice + '/' + allData.maxPrice + '/' + allData.minArea + '/' + allData.maxArea;
            }
            if (allData.category_id && allData.city_id && allData.minPrice && allData.maxPrice && allData.minArea &&
                allData.maxArea && allData.bed === "" && allData.bath === "" && allData.title === "") {
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-price-area/' + allData.category_id +
                    '/' + allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' + allData
                    .minArea + '/' + allData.maxArea;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-price-area/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' + allData.minArea +
            ...
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice === "" && allData
                .maxPrice === "" && allData.minArea === "" && allData.maxArea === "" && allData.bed && allData
                .bath && allData.title === "") {
                var api_url1 = window.location.href + '/../../api/properties/search-properties/bed-bath/' + allData
                    .bed + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/bed-bath/' + allData.bed + '/' + allData.bath;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice === "" && allData
                .maxPrice === "" && allData.minArea === "" && allData.maxArea === "" && allData.bed && allData
                .bath === "" && allData.title === "" && allData.title === "") {
                //bed
                var api_url1 = window.location.href + '/../../api/properties/search-properties/bed/' + allData.bed;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/bed/' + allData.bed;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice === "" && allData
                .maxPrice === "" && allData.minArea === "" && allData.maxArea === "" && allData.bed === "" &&
                allData.bath && allData.title === "" && allData.title === "") {
                //bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/bath/' + allData
                .bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/bath/' + allData.bath;
            }
            if (allData.category_id && allData.city_id === "" && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea === "" && allData.maxArea === "" && allData.bed && allData.bath === "" &&
                allData.title === "" && allData.title === "") {
                //category-bed
                var api_url1 = window.location.href + '/../../api/properties/search-properties/category-bed/' +
                    allData.category_id + '/' + allData.bed;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-bed/' + allData.category_id + '/' + allData.bed;
            }
            if (allData.category_id && allData.city_id === "" && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath &&
                allData.title === "" && allData.title === "") {
                //category-bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/category-bath/' +
                    allData.category_id + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-bath/' + allData.category_id + '/' + allData
                    .bath;
            }
            if (allData.category_id && allData.city_id === "" && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea === "" && allData.maxArea === "" && allData.bed && allData.bath && allData
                .title === "") {
                //category-bed-bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/category-bed-bath/' +
                    allData.category_id + '/' + allData.bed + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-bed-bath/' + allData.category_id + '/' + allData
                    .bed + '/' + allData.bath;
            }
            if (allData.category_id === "" && allData.city_id && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea === "" && allData.maxArea === "" && allData.bed && allData.bath === "" &&
                allData.title === "") {
                //city-bed
                var api_url1 = window.location.href + '/../../api/properties/search-properties/city-bed/' + allData
                    .city_id + '/' + allData.bed;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/city-bed/' + allData.city_id + '/' + allData.bed;
            }
            if (allData.category_id === "" && allData.city_id && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath &&
                allData.title === "") {
                //city-bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/city-bath/' + allData
                    .city_id + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/city-bath/' + allData.city_id + '/' + allData.bath;
            }
            if (allData.category_id === "" && allData.city_id && allData.minPrice === "" && allData.maxPrice ===
                "" && allData.minArea === "" && allData.maxArea === "" && allData.bed && allData.bath && allData
                .title === "") {
                //city-bed-bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/city-bed-bath/' +
                    allData.city_id + '/' + allData.bed + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/city-bed-bath/' + allData.city_id + '/' + allData.bed +
                    '/' + allData.bath;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice && allData.maxPrice &&
                allData.minArea === "" && allData.maxArea === "" && allData.bed && allData.bath === "" && allData
                .title === "") {
                //price-bed
                var api_url1 = window.location.href + '/../../api/properties/search-properties/price-bed/' + allData
                    .minPrice + '/' + allData.maxPrice + '/' + allData.bed;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/price-bed/' + allData.minPrice + '/' + allData.maxPrice +
                    '/' + allData.bed;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice && allData.maxPrice &&
                allData.minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath && allData
                .title === "") {
                //price-bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/price-bath/' +
                    allData.minPrice + '/' + allData.maxPrice + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/price-bath/' + allData.minPrice + '/' + allData.maxPrice +
                    '/' + allData.bath;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice && allData.maxPrice &&
                allData.minArea === "" && allData.maxArea === "" && allData.bed && allData.bath && allData.title ===
                "") {
                //price-bed-bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/price-bed-bath/' +
                    allData.minPrice + '/' + allData.maxPrice + '/' + allData.bed + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/price-bed-bath/' + allData.minPrice + '/' + allData
                    .maxPrice + '/' + allData.bed + '/' + allData.bath;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice === "" && allData
                .maxPrice === "" && allData.minArea && allData.maxArea && allData.bed && allData.bath === "" &&
                allData.title === "") {
                //area-bed
                var api_url1 = window.location.href + '/../../api/properties/search-properties/area-bed/' + allData
                    .minArea + '/' + allData.maxArea + '/' + allData.bed;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/area-bed/' + allData.minArea + '/' + allData.maxArea +
                    '/' + allData.bed;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice === "" && allData
                .maxPrice === "" && allData.minArea && allData.maxArea && allData.bed === "" && allData.bath &&
                allData.title === "") {
                //area-bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/area-bath/' + allData
                    .minArea + '/' + allData.maxArea + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/area-bath/' + allData.minArea + '/' + allData.maxArea +
                    '/' + allData.bath;
            }
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice === "" && allData
                .maxPrice === "" && allData.minArea && allData.maxArea && allData.bed && allData.bath && allData
                .title === "") {
                //area-bed-bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/area-bed-bath/' +
                    allData.minArea + '/' + allData.maxArea + '/' + allData.bed + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/area-bed-bath/' + allData.minArea + '/' + allData
                    .maxArea + '/' + allData.bed + '/' + allData.bath;
            }
            if (allData.category_id && allData.city_id && allData.minPrice === "" && allData.maxPrice === "" &&
                allData.minArea === "" && allData.maxArea === "" && allData.bed && allData.bath === "" && allData
                .title === "") {
                //category-city-bed
                var api_url1 = window.location.href + '/../../api/properties/search-properties/category-city-bed/' +
                    allData.category_id + '/' + allData.city_id + '/' + allData.bed;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-bed/' + allData.category_id + '/' + allData
                    .city_id + '/' + allData.bed;
            }
            if (allData.category_id && allData.city_id && allData.minPrice === "" && allData.maxPrice === "" &&
                allData.minArea === "" && allData.maxArea === "" && allData.bed === "" && allData.bath && allData
                ...
                //category-city-bath
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-bath/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-bath/' + allData.category_id + '/' + allData
                    .city_id + '/' + allData.bath;
            }
            if (allData.category_id && allData.city_id && allData.minPrice === "" && allData.maxPrice === "" &&
                allData.minArea === "" && allData.maxArea === "" && allData.bed && allData.bath && allData.title ===
                ...
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-bed-bath/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.bed + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-bed-bath/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.bed + '/' + allData.bath;
            ...
            if (allData.category_id && allData.city_id && allData.minPrice && allData.maxPrice && allData
                ...
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-price-bed/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' + allData.bed;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-price-bed/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' + allData.bed;
            }
            if (allData.category_id && allData.city_id && allData.minPrice && allData.maxPrice && allData
                ...
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-price-bath/' + allData.category_id +
                    '/' + allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-price-bath/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' + allData.bath;
            }
            if (allData.category_id && allData.city_id && allData.minPrice && allData.maxPrice && allData
                ...
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-price-bed-bath/' + allData.category_id +
                    '/' + allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' + allData.bed +
                    '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-price-bed-bath/' + allData.category_id +
            ...
            if (allData.category_id && allData.city_id && allData.minPrice === "" && allData.maxPrice === "" &&
                ...
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-area-bed/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.minArea + '/' + allData.maxArea + '/' + allData.bed;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-area-bed/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.minArea + '/' + allData.maxArea + '/' + allData.bed;
            }
            if (allData.category_id && allData.city_id && allData.minPrice === "" && allData.maxPrice === "" &&
                ...
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-area-bath/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.minArea + '/' + allData.maxArea + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-area-bath/' + allData.category_id + '/' +
                    allData.city_id + '/' + allData.minArea + '/' + allData.maxArea + '/' + allData.bath;
            }
            if (allData.category_id && allData.city_id && allData.minPrice === "" && allData.maxPrice === "" &&
                ...
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-area-bed-bath/' + allData.category_id +
                    '/' + allData.city_id + '/' + allData.minArea + '/' + allData.maxArea + '/' + allData.bed +
                    '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-area-bed-bath/' + allData.category_id +
            ...
            if (allData.category_id && allData.city_id && allData.minPrice && allData.maxPrice && allData.minArea &&
                ...
                var api_url1 = window.location.href +
                    '/../../api/properties/search-properties/category-city-price-area-bed-bath/' + allData
                    .category_id + '/' + allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' +
                    allData.minArea + '/' + allData.maxArea + '/' + allData.bed + '/' + allData.bath;
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/category-city-price-area-bed-bath/' + allData
                    .category_id + '/' + allData.city_id + '/' + allData.minPrice + '/' + allData.maxPrice + '/' +
            ...
            if (allData.category_id === "" && allData.city_id === "" && allData.minPrice === "" && allData
                .maxPrice === "" && allData.minArea === "" && allData.maxArea === "" && allData.bed === "" &&
                allData.bath === "" && allData.title) {
                //category-city-price-area-bed-bath
                var api_url1 = window.location.href + '/../../api/properties/search-properties/title/' + allData
                    .title
                var api_url = api_url1.substring(0, api_url1.indexOf('?')) +
                    '/../api/properties/search-properties/title/' + allData.title;
            }
            console.log(api_url);
