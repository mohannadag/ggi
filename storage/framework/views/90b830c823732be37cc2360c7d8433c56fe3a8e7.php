    ...
    <div class="container">
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <span class="text-secondary text-tiny inline-block mb-2"><?php echo e(trans('file.newly')); ?></span>
            </div>
            <div class="col-span-12 flex flex-wrap flex-col md:flex-row items-start justify-between mb-[50px]">
                <div class="mb-5 lg:mb-0">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium">
                        <?php echo e(trans('file.recently_added')); ?><span class="text-secondary">.</span></h2>
                </div>
                <ul class="all-properties flex flex-wrap lg:pt-[10px]">
                    <li data-tab="all-properties" class="mr-[30px] md:mr-[45px] mb-4 lg:mb-0 leading-none active"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out"><?php echo e(trans('file.all_listings')); ?></button></li>
                    <li data-tab="Projects" class="mr-[30px] md:mr-[45px] mb-4 lg:mb-0 leading-none"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out"><?php echo e(trans('file.projects')); ?></button></li>
                    <li data-tab="Apartments" class="mr-[30px] md:mr-[45px] mb-4 lg:mb-0 leading-none"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out"><?php echo e(trans('file.apartments')); ?></button></li>
                    <li data-tab="Lands" class="mr-[30px] md:mr-[45px] mb-4 lg:mb-0 leading-none"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out"><?php echo e(trans('file.lands')); ?></button></li>
            </div>
            <div class="col-span-12">
                <div class="all-properties properties-tab-content active">
                    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                        <?php $__currentLoopData = $properties->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="<?php echo e(route('front.property', ['property' => $property->id])); ?>" class="block">
                                            <img src="<?php echo e(URL::asset('/images/thumbnail/' . $property->thumbnail)); ?>" class="w-full h-full" loading="lazy" width="370" height="266" alt="<?php echo e($property->property_id); ?>">
                                        </a>
                                    </div>
                                    ...
                                    <div class="py-[20px] px-[20px] text-<?php echo e(App::isLocale('ar') ? 'right' : 'left'); ?>">
                                        <h3><a href="<?php echo e(route('front.property', ['property' => $property->id])); ?>"
                                                class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium"><?php echo e($property->property_id); ?></a>
                                        </h3>
                                        <h4><a href="<?php echo e(route('front.property', ['property' => $property->id])); ?>"
                                                ...
                                                <?php echo e($city[$property->city_id]->cityTranslation->name ?? ($city[$property->city_id]->cityTranslationEnglish->name ?? null)); ?></a>
                                        </h4>
                                        <span
                                            class="font-light text-sm"><?php echo e($property->category->categoryTranslation->name); ?></span>
                                        <ul
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        ...
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="<?php echo e(asset('frontend/images/icon/camera.png')); ?>" loading="lazy" width="13" height="10" alt="camera icon"><?php echo e($property->image->count('property_id')); ?></button>
                                            <button class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="<?php echo e(asset('frontend/images/icon/video.png')); ?>" loading="lazy" width="14" height="10" alt="camera icon">01</button>
                                        </div>
...
<?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/includes/featured-property.blade.php ENDPATH**/ ?>