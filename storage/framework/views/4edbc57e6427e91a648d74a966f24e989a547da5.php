                        ...
                        <div class="col-span-12">
                            ...
                            ?>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="<?php echo e(route('front.project', ['property' => $property->id])); ?>" class="block"><img src="<?php echo $property->photo(); ?>" class="w-full h-full" loading="lazy" width="370" height="266" alt="<?php echo e($property->propertyTranslation->title ?? ($property->propertyTranslationEnglish->title ?? null)); ?>"></a>
                                    ...
                                    <div class="py-[20px] px-[20px] text-<?php echo e(App::isLocale('ar') ? 'right' : 'left'); ?>">
                                        <h3><a href="<?php echo e(route('front.project', ['property' => $property->id])); ?>" class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium"><?php echo e($property->title); ?></a></h3>
                            ...
                            <div class="grid grid-cols-1 gap-[30px]">
                                ...
                                <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                    <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                        ...
                                        <a href="<?php echo e(route('front.project', ['property' => $property->id])); ?>" class="block h-[250px]">
                                            <img src="<?php echo $property->photo(); ?>" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="<?php echo e($property->propertyTranslation->title ?? ($property->propertyTranslationEnglish->title ?? null)); ?>">
                                        </a>
                                    ...
                                    <div class="flex flex-col relative w-full lg:w-[calc(100%-300px)]">
                                        <div class="text-left px-4 lg:px-0 w-full md:w-auto md:flex-1 lg:mr-7 xl:mr-[55px] bg-[#FFFDFC] lg:ml-[30px]">
                                            <h3><a href="<?php echo e(route('front.project', ['property' => $property->id])); ?>" class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary font-medium"><?php echo e($property->propertyTranslation->title ?? ($property->propertyTranslationEnglish->title ?? null)); ?>.</a></h3>
                                            <h4><a href="<?php echo e(route('front.project', ['property' => $property->id])); ?>" class="font-light text-tiny underline">
                                                <?php echo e($property->country->countryTranslation->name ?? ($property->country->countryTranslationEnglish->name ?? null)); ?>,
                                                <?php echo e($property->state->stateTranslation->name ?? ($property->state->stateTranslationEnglish->name ?? null)); ?>,
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-[30px]">
                    ...
                    <div class="mb-[40px]">
                        ...
                        <form class="relative" action="<?php echo e(route('search.project')); ?>" method="GET">
                            <?php echo csrf_field(); ?>
                            <input id="property_name" name="property_name" class="form-control font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] pr-[45px] pl-[20px] py-[10px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white" type="text" placeholder="<?php echo e(old('property_name', request()->property_name)); ?>">
                    ...
                    <div class="mb-[40px]">
                        ...
                        <form class="relative" action="<?php echo e(route('search.project')); ?>" method="GET">
                            <?php echo csrf_field(); ?>
                            <input id="property_id" name="property_id" class="form-control font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] pr-[45px] pl-[20px] py-[10px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] bg-white" type="text" placeholder="<?php echo e(old('property_id', request()->property_id)); ?>">
                            <button class="absolute top-1/2 -translate-y-1/2 z-[1] right-[20px]">
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5.19559 0C8.06048 0 10.3913 2.33078 10.3913 5.19568C10.3913 6.18406 10.1138 7.10865 9.63257 7.89615C12.3593 10.0392 12.6608 10.3403 12.7621 10.442L13.5201 11.2C14.16 11.8398 14.16 12.8807 13.5201 13.5202C13.2004 13.8399 12.78 14 12.36 14C11.94 14 11.5196 13.8399 11.1999 13.5202L10.4419 12.7622C10.341 12.6612 10.0391 12.3594 7.90845 9.625C7.1184 10.1106 6.18908 10.3914 5.19559 10.3914C4.41501 10.3914 3.66434 10.2222 2.96434 9.88896C2.69163 9.75917 2.57569 9.4325 2.70585 9.15979C2.83564 8.88708 3.16231 8.77114 3.43465 8.9013C3.98663 9.16417 4.57908 9.2976 5.19559 9.2976C7.45746 9.2976 9.29751 7.45755 9.29751 5.19568C9.29751 2.9338 7.4571 1.09375 5.19559 1.09375C2.93408 1.09375 1.09366 2.9338 1.09366 5.19568C1.09366 5.93651 1.29309 6.6624 1.67043 7.29458C1.82538 7.5538 1.74043 7.88958 1.48121 8.04453C1.22163 8.19948 0.886212 8.11453 0.731265 7.85531C0.252932 7.05359 -8.96454e-05 6.13411 -8.96454e-05 5.19604C-8.96454e-05 2.33078 2.33069 0 5.19559 0ZM11.2152 11.989L11.9728 12.7469C12.1861 12.9602 12.5332 12.9602 12.7465 12.7469C12.9598 12.5336 12.9598 12.1869 12.7465 11.9736L11.9885 11.2157C11.8532 11.0801 11.2765 10.5798 8.96757 8.76495C8.90522 8.83094 8.84106 8.89547 8.77507 8.95818C10.5845 11.2795 11.0811 11.8544 11.2152 11.989ZM2.43496 3.99911C2.31465 4.2762 2.44189 4.59812 2.71897 4.71844C2.7897 4.74906 2.86371 4.76401 2.93626 4.76401C3.14736 4.76401 3.34861 4.64078 3.4383 4.43479C3.74236 3.73406 4.43215 3.28125 5.19559 3.28125C5.49783 3.28125 5.74246 3.03661 5.74246 2.73438C5.74246 2.43214 5.49783 2.1875 5.19559 2.1875C3.99611 2.1875 2.91257 2.8988 2.43496 3.99911Z" fill="#0b2c3d" />
                                </svg>
                        ...
                        <?php echo $__env->make('frontend.includes.search-projects', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                        <div class="mb-[60px]">
                            <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[40px] font-medium"><?php echo e(trans('file.featured')); ?><span class="text-secondary">.</span></h3>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_3px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center">
                                                <div class="relative">
                                                    <a href="<?php echo e(route('front.project', ['property' => $property->id])); ?>" class="block">
                                                ...
                                                <div class="pt-[15px] pb-[20px] px-[20px] text-left">
                                                    <h3><a href="<?php echo e(route('front.project', ['property' => $property->id])); ?>" class="font-lora leading-tight text-[18px] text-primary"><?php echo e($property->propertyTranslation->title ?? ($property->propertyTranslationEnglish->title ?? null)); ?></a></h3>
                                                    <h4 class="leading-none"><a href="<?php echo e(route('front.project', ['property' => $property->id])); ?>" class="font-light text-[14px] leading-[1.75] text-primary underline"><?php echo e($property->country->countryTranslation->name ?? ($property->country->countryTranslationEnglish->name ?? null)); ?>,
                                                        <?php echo e($property->state->stateTranslation->name ?? ($property->state->stateTranslationEnglish->name ?? null)); ?>,
                                                        <?php echo e($property->city->cityTranslation->name ?? ($property->city->cityTranslationEnglish->name ?? null)); ?></a></h4>
                                                    <ul class="mt-[10px]">
                                                        <li class="flex flex-wrap items-center justify-between">
...
<?php echo $__env->make('frontend.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/get-project.blade.php ENDPATH**/ ?>