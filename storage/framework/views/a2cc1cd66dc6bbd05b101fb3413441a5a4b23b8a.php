            ...
            <div class="form-side p-6">
                ...
                <div class="popup-contact-form-wrapper contact-form text-center p-4 mb-3" id="contact-form-modal">
                    <form class="space-y-6" id="subscribeform">
                        <div>
                            <input type="text" name="ModalName" id="ModalName" placeholder="<?php echo e(trans('file.name')); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mb-3" required>
                        </div>
                        <div>
...
<?php $__env->stopPush(); ?><?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/includes/popup-form.blade.php ENDPATH**/ ?>