                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="acquisitiong_title" class="form-control filter-input" value="<?php echo e($citizenship->citizenshipTranslation->acquisitiong_title); ?>" placeholder="Page Title">
                                        <?php $__errorArgs = ['acquisitiong_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
