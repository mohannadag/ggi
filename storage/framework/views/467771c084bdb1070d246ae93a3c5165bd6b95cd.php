    ...
    <div id="modello" class="relative w-full max-w-2xl md:h-auto px-[40px] py-33333 bg-contain bg-right-top bg-no-repeat">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="px-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white"><?php echo e(trans('file.search')); ?></h3>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/includes/searchpopup.blade.php ENDPATH**/ ?>