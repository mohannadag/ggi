    ...
    <section class="mt-6 mb-20 text-neutral-700">
        <div class="grid gap-12 lg:grid-cols-3">
            <div class="order-2 lg:order-1 col-span-2">
                <div class="pb-2 mt-6">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize lg font-medium"><?php echo e($citizenship->citizenshipTranslation->obtaining_title); ?><span class="text-secondary">.</span></h2>
                </div>
                ...
                <div class="pb-2 mt-6">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize lg font-medium"><?php echo e($citizenship->citizenshipTranslation->acquisition_title); ?><span class="text-secondary">.</span></h2>
                </div>
                ...
                <div class="pb-2 mt-6">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize lg font-medium"><?php echo e($citizenship->citizenshipTranslation->documents_title); ?><span class="text-secondary">.</span></h2>
                </div>
                ...
                <div class="pb-2 mt-6">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize lg font-medium"><?php echo e($citizenship->citizenshipTranslation->stages_title); ?><span class="text-secondary">.</span></h2>
                </div>
                <?php echo $citizenship->citizenshipTranslation->stages_text; ?>

            </div>
            <div class="order-1 lg:order-2 col-span-1 sticky">
                <div class="diagram">
                    <ul class="p-0 mb-0">
                        <li>
                            <div class="step">
