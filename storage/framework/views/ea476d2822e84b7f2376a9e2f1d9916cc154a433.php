                ...
                <div class="flex flex-wrap items-center justify-between">
                    ...
                    <nav class="flex flex-wrap items-center">
                                ...
                                <ul class="list-none bg-white drop-shadow-[0px_6px_10px_rgba(0,0,0,0.2)] rounded-[12px] flex flex-wrap w-[890px] absolute top-[120%] left-1/2 translate-x-[-40%] xl:translate-x-[-45%] transition-all group-hover:top-[100%] invisible group-hover:visible opacity-0 group-hover:opacity-100 <?php echo e(App::isLocale('ar') ? 'px-[41px]' : 'px-[40px]'); ?> py-[45px] bg-contain bg-right-top bg-no-repeat " style="background-image: url('../images/states/europe.jpg'); ">
                                    ...
                                    <li class="mr-[70px]">
                                        <ul>
                                            ...
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="<?php echo e(route('property.state',$state)); ?>" class="font-lora text-[14px] hover:text-secondary"><?php echo e($state->stateTranslation->name ?? ($state->stateTranslationEnglish->name ?? null)); ?></a>
                                            </li>
                                    ...
                                    <li class="mr-[70px]">
                                        <ul>
                                            ...
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="<?php echo e(url('/search-sale?&category_id=1')); ?>" class="font-lora text-[14px] hover:text-secondary"><?php echo e(trans('file.apartment')); ?></a>
                                            </li>
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="<?php echo e(url('/search-sale?&category_id=3')); ?>" class="font-lora text-[14px] hover:text-secondary"><?php echo e(trans('file.land')); ?></a>
                                            </li>
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="<?php echo e(url('/search-sale?&category_id=5')); ?>" class="font-lora text-[14px] hover:text-secondary"><?php echo e(trans('file.project')); ?></a>
                                            </li>
                                    ...
                                    <li class="mr-[70px]">
                                        <ul>
                                            ...
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="<?php echo e(url('/search-sale?_token=FjPsIGldRhfwRg2GZoTDxfn2A1sTfdJfHpMGWvXb&state=&city_id=&category_id=&minPrice=1&maxPrice=2000000&bed=&bath=&garage=')); ?>" class="font-lora text-[14px] hover:text-secondary"><?php echo e(trans('file.property_for_sale')); ?></a>
                                            </li>
                                        </ul>
                                    </li>
                        ...
                        <ul class="flex flex-wrap items-center">
                            ...
                            <li class="sm:mr-5 xl:mr-[20px] sm:ml-5 xl:ml-[20px] relative group"><a href="<?php echo e(route('admin.users.index')); ?>">
                                    <img src="<?php echo e(URL::asset('/images/users/'.$user->image)); ?>" loading="lazy" width="62" height="62" alt="avater" style="border-radius:100%; margin: 0 auto; overflow:hidden;">
                                </a>
...
<!-- Header end -->
<?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/citizenship/header.blade.php ENDPATH**/ ?>