 ...
 <?php if(Cookie::get('popupform') !== null ): ?>
 <!-- Modal -->
 <?php elseif(Cookie::get('popupform') == null ): ?>
     ...
     <div class="popup-body" style="display: block;">
         <div class="popup-window">
             <div class="window-wrapper">
                 ...
                 <div class="form-side">
                     <p class="form-side-header text-secondary font-karla"><?php echo e(trans('file.consult')); ?></p>
                     <p class="form-side-description text-primary font-karla"><?php echo e(trans('file.consult_desc')); ?></p>
                     ...
                     <div class="popup-contact-form-wrapper contact-form text-center p-4 mb-3" id="contact-form-modal">
                         <form class="space-y-6" id="subscribeform">
                             <div>
                                 <input type="text" name="PopupName" id="PopupName" placeholder="<?php echo e(trans('file.name')); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mb-3" required>
                             </div>
                             <div>
                                 <input type="text" name="PopupPhone" id="PopupPhone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mb-3" placeholder="<?php echo e(trans('file.phone')); ?>" required>
                             </div>
                             <div>
                                 <input type="email" name="PopupEmail" id="PopupEmail" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mb-3" placeholder="<?php echo e(trans('file.email')); ?>" required>
                             </div>
                             <button id="submit" type="submit" class="w-full text-primary bg-secondary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><?php echo e(trans('file.submit')); ?></button>
                         </form>
                     </div>

                     <p class="free-consultation"><?php echo e(trans('file.consult_footer')); ?></p>
                 </div>
             </div>
         </div>
     </div>
 ...
 <?php $__env->stopPush(); ?><?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/includes/popup.blade.php ENDPATH**/ ?>