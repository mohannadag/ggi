            ...
            <div class="col-span-12">
                <div class="flex flex-col items-center justify-center mb-[50px]">
                    ...
                    <h2 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium">
                        <?php echo e(trans('file.for_citizenship')); ?><span class="text-secondary">.</span></h2>
                </div>
            </div>
        </div>
                        ...
                        <div
                            ...
                            <div class="relative">
                                <a href="<?php echo e(route('front.property', ['property' => $property->id])); ?>" class="block">
                                    <img src="<?php echo e(URL::asset('/images/backgroundImage/' . $property->background_image)); ?>"

                                        alt="<?php echo e($propertyTranslation[$property->id]->title ?? ($propertyTranslationEnglish[$property->id]->title ?? null)); ?>">
                                </a>
                            </div>
                            ...
                            <div class="py-[20px] px-[20px] text-<?php echo e(App::isLocale('ar') ? 'right' : 'left'); ?>">
                                <h3><a href="<?php echo e(route('front.property', ['property' => $property->id])); ?>"
                                        class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium"><?php echo e($property->property_id); ?></a></h3>
                                <h4><a href="<?php echo e(route('front.property', ['property' => $property->id])); ?>"
                                        class="font-light text-[14px] leading-[1.75] underline"><?php echo e($country[$property->country_id]->countryTranslation->name ?? ($country[$property->country_id]->countryTranslationEnglish->name ?? null)); ?>,
                                ...
                                <ul class="flex flex-wrap items-center justify-between text-[12px] mt-[10px] mb-[15px] pb-[10px] border-b border-[#E0E0E0]">
                                    ...
                                    <li class="flex flex-wrap items-center">
                                        <?php if($property->category_id == 5): ?>
                                        <?php if($property->propertyDetails->delivery_year < 2022): ?>
                                        <span>Ready</span>
