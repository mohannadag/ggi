                        ...
                        <div class="swiper-slide">
                            ...
                            <?php endif; ?>
                                <div class="inline-block relative bg-primary text-primary rounded-[30px] z-10">
                                    <img src="<?php echo e(asset('/images/images/'.$testimonial->file)); ?>" class="w-auto h-auto block mx-auto relative z-[2] thumb" loading="lazy" width="402" height="505" alt="<?php echo e($testimonial->name); ?>">
...
<!-- Brand section End-->
<?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/includes/testimontials.blade.php ENDPATH**/ ?>