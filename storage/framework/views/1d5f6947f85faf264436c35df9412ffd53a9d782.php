                ...
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div class="text-center text-white relative">
                            <h1 class="font-lora text-[36px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl font-medium"><?php echo e($news->blogTranslation->title ?? $news->blogTranslationEnglish->title  ?? null); ?></h1>
                            <p class="text-base mt-5 max-w-[500px] mx-auto text-center" style=""><?php echo e(trans('file.news')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
                    <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                        <img src="<?php echo e(URL::asset('/images/gallery/'.$news->image)); ?>" class="w-auto h-auto" loading="lazy" alt="<?php echo e($news->blogTranslation->title ?? $news->blogTranslationEnglish->title  ?? null); ?>" width="770" height="465">
                        <div class="mt-[55px] mb-[35px]">
                            <span
                                class="block leading-none font-normal text-[18px] text-secondary mb-[15px]"><?php echo e($news->user->f_name); ?> <?php echo e($news->user->l_name); ?> | <?php echo e($createdAt->toFormattedDateString()); ?></span>
                            <h2 class="font-lora leading-tight text-[22px] md:text-[28px] lg:text-[32px] text-primary mb-[10px] font-medium"> <?php echo e($news->blogTranslation->title ?? $news->blogTranslationEnglish->title  ?? null); ?></h2>

                            <p class="max-w-[767px]"><?php echo $news->blogTranslation->body ?? $news->blogTranslation->body  ?? null; ?></p>
                        </div>
                        ...
                        <div class="flex flex-wrap items-center justify-between mt-[25px] mb-[-15px] pt-[20px] border-t border-[#E0E0E0]">
                            <div class="flex flex-wrap mb-[15px]">
                                ...
                                <a class="font-light hover:text-secondary ml-[5px]" href="#"><?php echo e($tag->tagTranslation->name ?? $tag->tagTranslationEnglish->name  ?? null); ?>,</a>
                            ...
                            <div class="flex flex-wrap mb-[15px]">
                                ...
                                <ul class="inline-flex items-center justify-center">
                                    <li class="ml-[15px]">
                                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(url()->current()); ?>" target="_blank" class="w-[26px] h-[26px] transition-all rounded-full bg-[#E8F1FF] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                    ...
                                    <li class="ml-[15px]">
                                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(url()->current()); ?>" target="_blank" class="w-[26px] h-[26px] transition-all rounded-full bg-[#E8F1FF] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                    ...
                                    <li class="ml-[15px]">
                                        <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(url()->current()); ?>" target="_blank" class="w-[26px] h-[26px] transition-all rounded-full bg-[#E8F1FF] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                        ...
                        <aside class="mb-[-40px]">
                            ...
                            <div class="mb-[40px]">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-x-[30px] md:gap-x-[0px] relative">
                                    <?php $__currentLoopData = $recentlyAddedPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recentlyAddedPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                        $createdAt = \Carbon\Carbon::parse($news->created_at);
                                    ?>
                                    <div class="flex items-center mb-[20px]">
                                        <div class="relative w-[127px]">
                                            <a href="#" class="block w-full">
                                                <img src="<?php echo e(URL::asset('/images/thumbnail/'.$recentlyAddedPost->image)); ?>" class="w-full" alt="Post">
                                            </a>
                                        </div>
                            ...
                            <div class="mb-[40px]">
                                <h3 class="text-primary leading-none text-[24px] font-lora underline mb-[30px] font-medium"><?php echo e(trans('file.tags')); ?><span class="text-secondary">.</span></h3>
                                <ul class="flex flex-wrap my-[-7px] mx-[-5px] font-light text-[12px]">
                                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="my-[7px] mx-[5px]"><a href="#" class="leading-none border border-[#E0E0E0] py-[8px] px-[10px] block rounded-[4px] hover:text-secondary"><?php echo e($tag->tagTranslation->name ?? $tag->tagTranslationEnglish->name  ?? null); ?></a>
                                    </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/single-news.blade.php ENDPATH**/ ?>