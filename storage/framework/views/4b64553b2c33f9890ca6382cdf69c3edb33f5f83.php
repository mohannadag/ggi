        ...
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                ...
                <a href="<?php echo e(url('/')); ?>" class="block">
                        <img width="60px" src="<?php echo e(asset('frontend/images/logo/logo.png')); ?>" loading="lazy" alt="Golden Group Investment logo"> </a>
                    <nav class="flex flex-wrap items-center">
                        <ul class="hidden lg:flex flex-wrap items-center font-lora text-[12px] xl:text-[14px] leading-none text-black <?php echo e(App::isLocale('ar') ? 'lg:ml-[100px] xl:ml-[50px]' : ''); ?>">
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                ...
                                <a href="<?php echo e(url('/')); ?>" id="sticky-color"
                                    class="sticky-dark transition-all text-white hover:text-secondary"><?php echo e(trans('file.home')); ?></a>

                            </li>
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                <a href="<?php echo e(url('/about')); ?>" id="about-color" class="sticky-dark transition-all text-white hover:text-secondary"><?php echo e(trans('file.about')); ?></a>

                            </li>
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                <a href="<?php echo e(url('/properties')); ?>" id="properties-color" class="sticky-dark transition-all text-white hover:text-secondary"><?php echo e(trans('file.turkey_properties')); ?></a>
                                <ul class="list-none bg-white drop-shadow-[0px_6px_10px_rgba(0,0,0,0.2)] rounded-[12px] flex flex-wrap w-[890px] absolute top-[120%] left-1/2 translate-x-[-40%] xl:translate-x-[-45%] transition-all group-hover:top-[100%] invisible group-hover:visible opacity-0 group-hover:opacity-100 px-[40px] py-[45px] bg-contain bg-right-top bg-no-repeat "
                                    ...
                                    <li class="<?php echo e(App::isLocale('ar') ? 'mr-[200px]' : 'mr-[70px]'); ?>">
                                        <ul>
                            ...
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                ...
                                <a href="<?php echo e(url('/news')); ?>" id="news-color" class="sticky-dark transition-all text-white hover:text-secondary"><?php echo e(trans('file.news')); ?></a>
                            ...
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                ...
                                <a href="<?php echo e(url('/contact')); ?>" id="contact-color" class="sticky-dark transition-all text-white hover:text-secondary"><?php echo e(trans('file.contact')); ?></a>

                            </li>
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                <a href="<?php echo e(url('/virtual')); ?>" class="sticky-dark transition-all text-white hover:text-secondary"><img style="max-width: 31px; height: auto; filter: invert(1);" src="<?php echo e(URL::asset('/frontend/images/360-degrees.png')); ?>"></a>

                            </li>

                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                <a class="sticky-dark transition-all text-white hover:text-secondary"><img style="max-width: 31px; height: auto; filter: invert(1);" src="<?php echo e(URL::asset('/frontend/images/lang.svg')); ?>"></a>
                            ...
                            <li class="mr-7 xl:mr-[20px] relative group py-[20px]">
                                <a class="sticky-dark transition-all text-white hover:text-secondary"><img style="max-width: 31px; height: auto; filter: invert(1);" src="<?php echo e(URL::asset('/frontend/images/currency.svg')); ?>"></a>
                                <ul class="list-none bg-white drop-shadow-[0px_6px_10px_rgba(0,0,0,0.2)] rounded-[12px] flex flex-wrap flex-col w-[220px] absolute top-[120%] left-1/2 -translate-x-1/2 transition-all group-hover:top-[100%] invisible group-hover:visible opacity-0 group-hover:opacity-100">
            ...
            <ul>
                <li class="relative block border-b-primary border-b first:border-t first:border-t-primary">
                    <a href="<?php echo e(url('/')); ?>"
                        class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5"><?php echo e(trans('file.home')); ?></a>
                </li>
                <li class="relative block border-b-primary border-b">
                    <a href="<?php echo e(url('/about')); ?>"
                        class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5"><?php echo e(trans('file.about')); ?></a>


                </li>
                <li class="relative block border-b-primary border-b">
                    <a href="<?php echo e(url('/properties')); ?>"
                        class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5"><?php echo e(trans('file.turkey_properties')); ?></a>

                </li>
                <li class="relative block border-b-primary border-b"><a href="<?php echo e(url('/page/turkish-citizenship')); ?>"
                        class="relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5"><?php echo e(trans('file.turkish_citizenship')); ?></a>

                </li>


                <li class="relative block border-b-primary border-b"><a href="<?php echo e(url('/news')); ?>" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5"><?php echo e(trans('file.news')); ?></a>
                </li>
                <li class="relative block border-b-primary border-b"><a href="<?php echo e(url('/contact')); ?>" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5"><?php echo e(trans('file.contact')); ?></a>
                </li>
...
<?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/includes/header.blade.php ENDPATH**/ ?>