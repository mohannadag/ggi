                            ...
                            <div class="swiper-slide ">
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    ...
                                    <div class="py-[20px] px-[20px] text-<?php echo e(App::isLocale('ar') ? 'right' : 'left'); ?>">
                                        ...
                                        <span class="font-light text-sm"><?php echo e($property->property_id); ?></span>
                                        <ul class="flex flex-wrap items-center justify-between text-[12px] mt-[10px] mb-[15px] pb-[10px] border-b border-[#E0E0E0]">
                                            ...
                                            <a href="<?php echo e($property->propertyDetails->whatsapp_link); ?>" class="flex flex-wrap items-center pr-[25px] sm:pr-[5px] md:pr-[25px] border-r border-[#E0DEDE]">
                                                <i class="fab fa-whatsapp fa-2x"></i>
                                            </a>
                                            <a href="<?php echo e($property->propertyDetails->prices_link); ?>" class="flex flex-wrap items-center pr-[25px] sm:pr-[5px] md:pr-[25px] border-r border-[#E0DEDE]">
                                                <img class="mr-[5px]" width="20" height="20" viewBox="0 0 14 14" fill="currentColor" src="<?php echo e(asset('/frontend/images/currency.svg')); ?>">
                                            </a>
                                            <a href="<?php echo e($property->propertyDetails->drive_link); ?>" class="flex flex-wrap items-center pr-[25px] sm:pr-[5px] md:pr-[25px] border-r border-[#E0DEDE]">
                                                <img class="mr-[5px]" width="20" height="20" viewBox="0 0 14 14" fill="currentColor" src="<?php echo e(asset('/frontend/images/drive.svg')); ?>">
                                            </a>
                                        </ul>
                        ...
                        <div class="sidebar-carousel relative">
                            <div class="swiper p-1">
                                ...
                                <div class="swiper-wrapper">
                                    <!-- Slides -->
                                    <?php $__currentLoopData = $properties->where('is_featured', 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide">
...
<script>
    $('#search-projects').on('keyup', function() {
        ...
        $.ajax({
            method: 'post',
            url: '<?php echo e(route('search.projects')); ?>',
            data: {
                search: search,
...
<?php echo $__env->make('frontend.projectsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/viperflux/Documents/GitHub/ggi-website/resources/views/frontend/projects.blade.php ENDPATH**/ ?>