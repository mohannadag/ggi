...
class NewsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend.news', compact('newses', 'popularTopics', 'tags', 'headerImage', 'properties', 'data','states', 'city', 'minPrice', 'maxPrice', 'minArea', 'maxArea', 'categories'));
    }
    ...
    public function show($news, Request $request)
    {
        ...
        return view('frontend.single-news', compact('news', 'popularTopics', 'recentlyAddedPosts', 'tags', 'previousPost', 'nextPost', 'previous', 'next', 'headerImage', 'properties', 'data','states', 'city', 'minPrice', 'maxPrice', 'minArea', 'maxArea', 'categories'));
    }
    ...
    public function tag($tag, Request $request){
        ...
        $newses = Blog::with('blogTranslation', 'user')
            ...
            ->paginate(4);
        $tags = Tag::with('tagTranslation', 'tagTranslationEnglish')->where('status', 1)->get();
            return view('frontend.news-tag', compact('newses', 'tag','tags', 'props', 'city', 'maxPrice', 'minPrice','propertyDetails', 'states','maxArea', 'minArea', 'properties', 'popularTopics', 'categories'));
    }
