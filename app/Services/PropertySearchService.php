...
class PropertySearchService
{
    ...
    public function getData($data)
    {
        ...
        // }elseif($data['category']=="" && $data['city']== "" && $data['minPrice'] && $data['maxPrice'] && $data['minArea'] =="" && $data['maxArea'] =="" && $data['bed']=="" && $data['bath']=="" && $data['title']=="" && $data['title_deed_type']==""){
        //     // dd(3);
        //     return $this->_propertySearchRepository->getByTitleDeed($data);
        // }elseif($data['category']=="" && $data['city']== "" && $data['minPrice']=="" && $data['maxPrice']=="" && $data['minArea'] && $data['maxArea'] && $data['bed']=="" && $data['bath']=="" && $data['title']==""){
        //     // dd('getByArea');
        ...
        // }
        // elseif($data['category']=="" && $data['city']=="" && $data['minPrice']=="" && $data['maxPrice']=="" && $data['minArea']=="" && $data['maxArea']=="" && $data['bed']=="" && $data['bath']=="" && $data['property_id']){
        //     // dd('CategoryCityPriceAreaBedBath');
        //     return $this->_propertySearchRepository->getByID($data);
        // }
        // elseif($data['category']=="" && $data['city']=="" && $data['minPrice']=="" && $data['maxPrice']=="" && $data['minArea']=="" && $data['maxArea']=="" && $data['bed']=="" && $data['bath']=="" && $data['property_name']){
        //     // dd('CategoryCityPriceAreaBedBath');
