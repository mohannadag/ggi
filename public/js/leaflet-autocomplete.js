$(document).ready(function() {
    ...
    var next;
    if (
        $("#autocomplete-container").attr("data-autocomplete-tip") === undefined
    ) {
        var autocompleteTip = "type and hit enter";
    } else {
        var autocompleteTip = $("#autocomplete-container").attr(
            "data-autocomplete-tip"
        );
    }

    $("#autocomplete-container").after(
        '<span class="type-and-hit-enter">' + autocompleteTip + "</span>"
    );
        ...
        if (e.keyCode == 13) {
            ...
            if (query) {
                geocoder.geocode(query, function(results) {
                    ...
                    $("#autocomplete-container").addClass(
                        "osm-dropdown-active"
                    );
