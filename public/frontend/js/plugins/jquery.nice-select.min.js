...
!(function(e) {
    ...
    (n.prototype = {
        utils: {
            ...
            format: function(e) {
                var t = arguments;
                return ("" + e).replace(/\{(?:(\d+)|(\w+))\}/g, function(
                    e,
                    s,
                    l
                ) {
        ...
        setLabel: function() {
            ...
            if (t.state.multiple) {
                ...
                t.elements.label.html(
                    e.isFunction(s) ? s(n) : t.utils.format(s, n)
                );
            }
        },
        populate: function() {
        ...
        bindEvents: function() {
            var t = this;
            t.elements.outerWrapper.on("mouseenter.sl mouseleave.sl", function(
                s
            ) {
                    ...
                    t.elements.input
                        ...
                        .on("focusin.sl", function(e) {
                            t.elements.outerWrapper.addClass(t.classes.focus),
                                ...
                                t.options.openOnFocus &&
                                    !t.state.opened &&
                                    t.open(e);
                        })
                        .on("focusout.sl", function() {
                            t.elements.outerWrapper.removeClass(
                                t.classes.focus
                            );
                        })
                ...
                t.state.multiple
                    ...
                    : t.state.currValue !== t.state.selectedIdx &&
                      (t.$element
                          ...
                          .data(
                              "value",
                              t.lookupItems[t.state.selectedIdx].text
                          ),
                      t.setLabel(),
                      t.utils.triggerCallback("Change", t));
        },
