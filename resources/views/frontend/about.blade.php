            ...
            <div class="grid grid-cols-12">
                <div class="col-span-12">
                    <div class="max-w-[830px] text-center mx-auto">
                        <div class="mb-5"><span class="text-base text-secondary block">{{trans('file.about_footer')}}</span></div>
                        <h1 class="font-lora text-primary text-[36px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl title font-medium">
                            {{trans('file.about')}}<span class="text-secondary">.</span>
                        </h1>
                        <p class="text-base mt-5">{{trans('file.about_desc')}}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="items-center">
                <div class="lg:mb-[60px] mb-10 -mt-[150px]">
                    <img class="mx-auto w-full" src="{{asset('frontend/images/about/232.png')}}" width="597" height="716" alt="about image">
                </div>
            ...
            <div class="grid grid-cols-12">
                <div class="col-span-12">
                    <div class="mb-[30px] lg:mb-[60px] text-center">
                        <span class="text-secondary text-tiny inline-block mb-2">{{trans('file.about_service_headline')}}</span>
                        <h2 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium">
                            {{trans('file.services_we_provide')}}<span class="text-secondary">.</span></h2>
                    </div>
                </div>
            </div>
                ...
                <div class="relative group">
                    <a class="block" href="{{ route('single-service', ['service' => $service->id]) }}">
                        ...
                        <div class="drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] hover:drop-shadow-[0px_8px_20px_rgba(0,0,0,0.15)] bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[25px] py-[25px]">
                            ...
                            <p class="font-light text-tiny">{{$service->serviceTranslation->description}}</p>
                        </div>
                    </a>
                </div>
                @endforeach
            ...
            <div class="container">
                    <div class="col-span-12">
                        <div class=" text-center mx-auto">
                            ...
                            <p class="font-light text-tiny mt-5">{{trans('file.extra_services')}}</p>
                        </div>
                    </div>
            </div>
        </div>
...
<section class="testimonial-section pt-[80px] lg:pt-[125px] bg-center bg-no-repeat bg-white z-10">
    <div class="container testimonial-carousel-two relative">
        <div class="scene dots-shape absolute left-0">
            <img data-depth="0.4" class="z-[1]" src="{{asset('frontend/images/testimonial/dots.png')}}" width="106" height="129" loading="lazy" alt="shape">
        </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            @endif
                                <div class="inline-block relative bg-primary text-primary rounded-[30px] z-10">
                                    <img src="{{asset('/images/images/'.$testimonial->file)}}" class="w-auto h-auto block mx-auto relative z-[2] thumb" loading="lazy" width="402" height="505" alt="Oliver Stephen">
                                    <img class="absolute left-[0px] top-0 z-[1]" src="{{asset('frontend/images/testimonial/persone-pattern.png')}}" width="400" height="500" loading="lazy" alt="shape">
                                </div>
                            </div>
                            ...
                            <div class="before:absolute before:top-1/2 before:-translate-y-1/2 before:left-0 before:w-full before:h-[395px] before:content-[''] before:bg-[#F5F9F8] before:rounded-[30px]">
                                ...
                                <div class="text-{{ App::isLocale('ar') ? 'right' : 'left' }} rounded-[14px] max-w-[100%] sm:max-w-[90%] md:max-w-[560px] mx-auto md:ml-auto absolute top-[65%] sm:top-1/2 left-0 md:left-auto right-0 md:right-[50px] xl:right-0 -translate-y-1/2 px-[20px] md:px-[30px] xl:pl-[0px] xl:pr-[60px]  py-[20px] md:py-[30px] z-20 bg-white xl:bg-transparent shadow lg:shadow-none scale-[0.8] sm:scale-100">
                                    <div class="relative">
                                        ...
                                        <span class="text-secondary text-tiny capitalize inline-block mb-[5px] xl:mb-[10px]">{{trans('file.testimonial')}}</span>
                                    ...
                                    <ul>
                                        <li class="flex flex-wrap items-center justify-between mt-4">
                                            <span class="font-lora text-[18px] leading-none capitalize text-secondary">{{$testimonial->name}}</span>
