        ...
        <div class="grid gap-12 lg:grid-cols-3">
            <div class="order-2 lg:order-1 col-span-2">
                ...
                <ul class="ml-[40px] list-disc">
                    ...
                    <li>{{trans('file.turkish-passport-li2')}}</li>
                    <li>{{trans('file.turkish-passport-li3')}}</li>
                    <li>{{trans('file.turkish-passport-li4')}}</li>
                    <li>{{trans('file.turkish-passport-li5')}}</li>
                </ul>
            </div>
            <div class="order-1 lg:order-2 col-span-1" style="direction: ltr;">
                <div class="diagram">
                    <ul class="p-0 mb-0">
                        <li>
                            <div class="step">
                            ...
                            <div class="title font-bold text-capitalize">{{trans('file.step1')}}</div>
                            <div class="image">
                                {{-- <img src="https://www.garsconsulting.com/assets/img/service-decoration.svg?v=1595230525" alt="service-decoration"> --}}
                                <img src="{{ URL::asset('/images/images/arrow.png') }}" alt="service-decoration">
                                <div class="duration">{{trans('file.duration1')}}</div>
                            </div>
                        </li>
                        <li>
                            <div class="step">
                            ...
                            <div class="title font-bold text-capitalize">{{trans('file.step2')}}</div>
                            <div class="image">
                                <img src="https://www.garsconsulting.com/assets/img/service-decoration.svg?v=1595230525" alt="service-decoration">
                                <div class="duration">{{trans('file.duration2')}}</div>
                            </div>
                        </li>
                        <li>
                            <div class="step">
                            ...
                            <div class="title font-bold text-capitalize">{{trans('file.step3')}}</div>
                            <div class="image">
                                <img src="https://www.garsconsulting.com/assets/img/service-decoration.svg?v=1595230525" alt="service-decoration">
                                <div class="duration">{{trans('file.duration3')}}</div>
                            </div>
                        </li>
                        <li>
                            <div class="step">
                            ...
                            <div class="title font-bold text-capitalize">{{trans('file.step4')}}</div>
                            <div class="image">
                                <img src="https://www.garsconsulting.com/assets/img/service-decoration.svg?v=1595230525" alt="service-decoration">
                                <div class="duration">{{trans('file.duration4')}}</div>
                            </div>
                        </li>
                        <li>
                            <div class="step">
                            ...
                            <div class="title font-bold text-capitalize">{{trans('file.step5')}}</div>
                            <div class="image">
                                <img src="https://www.garsconsulting.com/assets/img/service-decoration.svg?v=1595230525" alt="service-decoration">
                                <div class="duration">{{trans('file.duration5')}}</div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<div class="container mx-auto pb-12 px-4">
    ...
    <section class="mt-6 mb-20 text-neutral-700">
        <div class="grid gap-12 lg:grid-cols-3">
            <div class="order-2 lg:order-1 col-span-2">
                <div class="pb-2 mt-6">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize lg font-medium">{{$citizenship->citizenshipTranslation->obtaining_title}}<span class="text-secondary">.</span></h2>
                </div>
                {!! $citizenship->citizenshipTranslation->obtaining_text !!}


                <div class="pb-2 mt-6">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize lg font-medium">{{$citizenship->citizenshipTranslation->acquisition_title}}<span class="text-secondary">.</span></h2>
                </div>
                {!! $citizenship->citizenshipTranslation->acquisition_text !!}


                <div class="pb-2 mt-6">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize lg font-medium">{{$citizenship->citizenshipTranslation->documents_title}}<span class="text-secondary">.</span></h2>
                </div>
                {!! $citizenship->citizenshipTranslation->documents_text !!}


                <div class="pb-2 mt-6">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize lg font-medium">{{$citizenship->citizenshipTranslation->stages_title}}<span class="text-secondary">.</span></h2>
                </div>
                {!! $citizenship->citizenshipTranslation->stages_text !!}
            </div>
