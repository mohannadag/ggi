...
<section class="popular-properties py-12 bg-neutral-50 px-6 py-12 md:px-12" style="height: fit-content;">
    <div class="container">
                        ...
                        <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                            <div class="relative">
                                <a href="{{ route('front.property', ['property' => $property->property_id]) }}" class="block">
                                    <img src="{{ URL::asset('/images/backgroundImage/' . $property->background_image) }}" alt="{{ $property->property_id }}">
                                </a>
                            </div>
                            ...
                            <div class="py-[20px] px-[20px] text-{{ App::isLocale('ar') ? 'right' : 'left' }}">
                                ...
                                <h4><a href="{{ route('front.property', ['property' => $property->property_id]) }}" class="font-light text-[14px] leading-[1.75] underline">{{ $country[$property->country_id]->countryTranslation->name ?? ($country[$property->country_id]->countryTranslationEnglish->name ?? null) }},
