...
@endphp
<!-- Header start -->
<header id="sticky-headerr" class="relative bg-[#E9F1FF] lg:py-[20px] z-10 secondary-sticky">
    <div class="container">
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="flex flex-wrap items-center justify-between">
                    <a href="{{ url('/') }}" class="block">
                        <img width="150px" src="{{asset('frontend/images/logo/logo.png')}}" loading="lazy" alt="brand logo">
                    </a>
                    <nav class="flex flex-wrap items-center">
                        <ul class="hidden lg:flex flex-wrap items-center font-lora text-[16px] xl:text-[16px] leading-none text-black {{ App::isLocale('ar') ? 'lg:ml-[100px] xl:ml-[50px]' : '' }}">
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                <a href="{{url('/')}}" class="transition-all hover:text-secondary">{{trans('file.home')}}</a>
                            </li>
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                <a href="{{url('/about')}}" class="transition-all hover:text-secondary">{{trans('file.about')}}</a>
                            </li>
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                <a href="{{ url('/properties') }}" class="transition-all hover:text-secondary">{{trans('file.turkey_properties')}}</a>
                                <ul class="list-none bg-white drop-shadow-[0px_6px_10px_rgba(0,0,0,0.2)] rounded-[12px] flex flex-wrap w-[890px] absolute top-[120%] left-1/2 translate-x-[-40%] xl:translate-x-[-45%] transition-all group-hover:top-[100%] invisible group-hover:visible opacity-0 group-hover:opacity-100 {{ App::isLocale('ar') ? 'px-[41px]' : 'px-[40px]' }} py-[45px] bg-contain bg-right-top bg-no-repeat " style="background-image: url('../images/states/europe.jpg'); ">
                                    ...
                                    <li class="mr-[70px]">
                                        <ul>
                                            ...
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="{{route('property.state',$state)}}" class="font-lora text-[14px] hover:text-secondary">{{ $state->stateTranslation->name ?? ($state->stateTranslationEnglish->name ?? null) }}</a>
                                            </li>
                                            @endforeach
                                        </ul>
                                    </li>
                                    ...
                                    <li class="mr-[70px]">
                                        <ul>
                                            ...
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="{{url('/search-sale?&category_id=1')}}" class="font-lora text-[14px] hover:text-secondary">{{trans('file.apartment')}}</a>
                                            </li>
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="{{url('/search-sale?&category_id=3')}}" class="font-lora text-[14px] hover:text-secondary">{{trans('file.land')}}</a>
                                            </li>
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="{{url('/search-sale?&category_id=5')}}" class="font-lora text-[14px] hover:text-secondary">{{trans('file.project')}}</a>
                                            </li>
                                    ...
                                    <li class="mr-[70px]">
                                        <ul>
                                            ...
                                            <li class="mb-[25px] last:mb-0">
                                                <a href="{{url('/search-sale?_token=FjPsIGldRhfwRg2GZoTDxfn2A1sTfdJfHpMGWvXb&state=&city_id=&category_id=&minPrice=1&maxPrice=2000000&bed=&bath=&garage=')}}" class="font-lora text-[14px] hover:text-secondary">{{trans('file.property_for_sale')}}</a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                ...
                                <a href="{{url('/page/turkish-citizenship')}}" class="transition-all hover:text-secondary">{{trans('file.turkish_citizenship')}}</a>
                            </li>
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                <a href="{{url('/news')}}" class="transition-all hover:text-secondary">{{trans('file.news')}}</a>


                            </li>
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                <a href="{{url('/contact')}}" class="transition-all hover:text-secondary">{{trans('file.contact')}}</a>

                            </li>
                            <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                <a href="{{url('/virtual')}}" class="sticky-dark transition-all text-white hover:text-secondary"><img style="max-width: 31px; height: auto;" src="{{URL::asset('/frontend/images/360-degrees.png')}}"></a>

                            </li>
                            <li class="mr-7 xl:mr-[20px] relative group py-[20px]">

                                <a class="transition-all hover:text-secondary"><img style="max-width: 31px; height: auto;" src="{{URL::asset('/frontend/images/lang.svg')}}"></a>
                            ...
                            <li class="mr-7 xl:mr-[20px] relative group py-[20px]">
                                ...
                                <a href="#" class="transition-all hover:text-secondary">
                                    <img style="max-width: 31px; height: auto;" src="{{URL::asset('/frontend/images/currency.svg')}}">
                                </a>
                                <ul class="list-none bg-white drop-shadow-[0px_6px_10px_rgba(0,0,0,0.2)] rounded-[12px] flex flex-wrap flex-col w-[220px] absolute top-[120%] left-1/2 -translate-x-1/2 transition-all group-hover:top-[100%] invisible group-hover:visible opacity-0 group-hover:opacity-100">
                        ...
                        <ul class="flex flex-wrap items-center">
                            ...
                            <li class="sm:mr-5 xl:mr-[20px] sm:ml-5 xl:ml-[20px] relative group"><a href="{{ route('admin.users.index') }}">
                                    <img src="{{URL::asset('/images/users/'.$user->image)}}" loading="lazy" width="62" height="62" alt="avater" style="border-radius:100%; margin: 0 auto; overflow:hidden;">
                                </a>
        ...
        <nav class="offcanvas-menu mr-[20px]">
            <ul>
                <li class="relative block border-b-primary border-b first:border-t first:border-t-primary">
                    <a href="{{url('/')}}" class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">{{ trans('file.home') }}</a>

                </li>
                <li class="relative block border-b-primary border-b">
                    <a href="{{url('/about')}}" class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">{{ trans('file.about') }}</a>
                </li>
                <li class="relative block border-b-primary border-b">
                    <a href="{{url('/properties')}}" class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">{{trans('file.turkey_properties')}}</a>
                ...
                <li class="relative block border-b-primary border-b"><a href="{{url('/page/turkish-citizenship')}}" class="relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">{{trans('file.turkish_citizenship')}}</a>
                ...
                <li class="relative block border-b-primary border-b"><a href="{{url('/news')}}" class="relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">{{trans('file.news')}}</a>
                ...
                <li class="relative block border-b-primary border-b"><a href="{{url('/contact')}}" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5">{{trans('file.contact')}}</a></li>
