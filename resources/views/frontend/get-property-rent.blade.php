...
@include('frontend.includes.header1')
    ...
    @endphp
    <section class="bg-no-repeat bg-center bg-cover bg-[#FFF6F0] h-[350px] lg:h-[513px] flex flex-wrap items-center relative before:absolute before:inset-0 before:content-[''] before:bg-[#000000] before:opacity-[70%]" style="background-image: url('{{ url('frontend/images/breadcrumb/bg-1.png') }}');">
        <div class="container">
                                ...
                                <div class="swiper-slide">
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                        ...
                                        <div class="py-[20px] px-[20px] text-left">
                                            ...
                                            <h4><a href="{{ route('front.property', ['property' => $property->id]) }}" class="font-light text-[14px] leading-[1.75] underline">253 Montril Street, South Town, Miami</a></h4>
                                ...
                                <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                    <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                        ...
                                        <a href="{{ route('front.property', ['property' => $property->id]) }}" class="block h-[250px]">
                                            <img src="{!! $property->photo() !!}" class="w-full h-full rounded-tl-[6px] lg:rounded-bl-[6px] object-cover" loading="lazy" width="300" height="250" alt="{{ $property->propertyTranslation->title ?? ($property->propertyTranslationEnglish->title ?? null) }}">
                                        </a>

                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="{{('frontend/images/icon/camera.png')}}" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="{{('frontend/images/icon/video.png')}}" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                        </div>
                                        ...
                                        <div class="text-left px-4 lg:px-0 w-full md:w-auto md:flex-1 lg:mr-7 xl:mr-[55px] bg-[#FFFDFC] lg:ml-[30px]">
                                            ...
                                            <ul>
                                                <li class="flex flex-wrap items-center justify-between mt-[15px] mb-[10px] pt-[10px] border-t border-[#E0E0E0]">
                                                    <span class="font-lora text-base text-primary leading-none font-medium">Price: {{ $property->currency->icon }}{{ number_format($property->price) }}</span>
                                                    <span class="flex flex-wrap items-center">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_3px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center">
                                                <div class="relative">
                                                    ...
                                                    <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                        <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="{{url('frontend/images/icon/camera.png')}}" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                        <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="{{url('frontend/images/icon/video.png')}}" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                                    </div>
                                                ...
                                                <div class="pt-[15px] pb-[20px] px-[20px] text-left">
                                                    ...
                                                    <ul class="mt-[10px]">
                                                        <li class="flex flex-wrap items-center justify-between">
                                                            <span class="font-lora text-[14px] text-secondary leading-none">Price: {{ $property->currency->icon }} {{ number_format($property->price) }}</span>
                        ...
                        <div class="mb-[60px]">
                            ...
                            <div class="grid sm:grid-cols-2 lg:grid-cols-2 gap-x-[20px] mb-[-20px]">
                                ...
                                <div class="text-center group mb-[30px]">
                                    <div class="relative z-[1] rounded-[6px_6px_0px_0px]">
                                        <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#016450] before:w-full before:h-[calc(100%_-_30px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                            <img src="{{('frontend/images/team/person3.png')}}" class="w-full object-contain block mx-auto" loading="lazy" width="130" height="154" alt="Albert S. Smith">
                                        </a>
                                    </div>
                                ...
                                <div class="text-center group mb-[30px]">
                                    <div class="relative z-[1] rounded-[6px_6px_0px_0px]">
                                        <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#016450] before:w-full before:h-[calc(100%_-_30px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                            <img src="{{('frontend/images/team/person4.png')}}" class="w-full object-contain block mx-auto" loading="lazy" width="130" height="154" alt="Amelia Margaret">
                                        </a>
                                    </div>
