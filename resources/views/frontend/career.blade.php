...
@section('content')
    ...
    <section
        ...
        style="background-image: url('{{asset('frontend/images/breadcrumb/human-resource.jpg')}}');">
        <div class="container">
            <div class="grid grid-cols-12">
                <div class="col-span-12">
                    <div class="max-w-[700px]  mx-auto text-center text-white relative z-[1]">
                        <div class="mb-5"><span class="text-base block">{{trans('file.careers')}}</span></div>
                        <h1
                    ...
                    <div class="col-span-12 lg:col-span-12 mb-[30px]">
                        <div>
                            <h2
                                ...
                                {{trans('file.join_us')}}</h2>
                            <p class="mb-[40px]">
                                {{trans('file.career_desc')}}
                            </p>
                        </div>
                        <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize mb-[10px] font-medium">{{trans('file.resume_title')}}</h2>
                        <div class="grid grid-cols-12 gap-x-[20px] gap-y-[30px]">
                            ...
                            <div class="col-span-12 md:col-span-12">
                                <input
                                    ...
                                    type="text" placeholder="{{trans('file.name')}}" name="name" id="CareerName">
                            </div>

                            <div class="col-span-12 md:col-span-6">
                                <input
                                    class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] "
                                    type="email" placeholder="{{trans('file.email')}}" name="email" id="CareerEmail">
                            </div>

                            <div class="col-span-12 md:col-span-6">
                                <input
                                    class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] "
                                    type="text" placeholder="{{trans('file.phone')}}" name="phone" id="CareerPhone">
                            </div>

                            <div class="col-span-12 md:col-span-6">
                                <select
                                    class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] "
                                    type="text" placeholder="{{trans('file.experience')}}" name="experience" id="CareerExperience">
                                    <option value="">{{trans('file.experience')}}</option>
                                    <option value="0-6">{{trans('file.zero')}}</option>
                                    <option value="1">{{trans('file.one')}}</option>
                                    <option value="2">{{trans('file.two')}}</option>
                                    <option value="3">{{trans('file.three')}}</option>
                                    <option value="+3">{{trans('file.over_three')}}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <input
                                    class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] "
                                    type="text" placeholder="{{trans('file.previous_companies')}}" name="companies" id="CareerCompanies">
                            </div>

                            <div class="col-span-12 md:col-span-6">
                                <select
                                    class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] "
                                    type="text" placeholder="{{trans('file.nationality')}}" name="nationality" id="CareerNationality">
                                    <option value="">{{trans('file.nationality')}}</option>
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <select
                                    class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] "
                                    type="text" placeholder="{{trans('file.gender')}}" name="gender" id="CareerGender">
                                    <option value="">{{trans('file.gender')}}</option>
                            ...
                            <div class="col-span-12">
                                <label class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize mb-[10px] font-medium">{{trans('file.resume')}}</label>
                                <input type="file" class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] resize-none" name="image"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 mb-[30px] lg:mb-0  order-2 lg:order-none">
                        <button type="submit" name="send" class="before:rounded-md before:block before:absolute before:left-auto before:right-0 before:inset-y-0 before:-z-[1] before:bg-secondary before:w-0 hover:before:w-full hover:before:left-0 hover:before:right-auto before:transition-all leading-none px-[30px] py-[15px] capitalize font-medium text-white text-[14px] xl:text-[16px] relative after:block after:absolute after:inset-0 after:-z-[2] after:bg-primary after:rounded-md after:transition-all mb-[30px] lg:mb-0">{{trans('file.submit_application')}}</button>
            ...
            <div class="grid col-span-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-[30px] mb-[-30px]">
                ...
                <div
                    ...
                    <img class="self-center mr-[20px] sm:mr-[40px] lg:mr-[20px] xl:mr-[40px] sm:mb-[15px] lg:mb-0"
                        src="{{ asset('frontend/images/icon/map.png') }}" width="40" height="55" loading="lazy"
                        alt="image icon">
                    <div class="flex-1">
                        <h4
                            class="font-lora group-hover:text-secondary group-hover:transition-all leading-none text-[28px] text-primary mb-[10px]">
                            {{trans('file.our_address')}} <span class="text-secondary">.</span></h4>
                ...
                <div
                    class="flex hover:drop-shadow-[0px_16px_10px_rgba(0,0,0,0.1)] hover:bg-[#F5F9F8] transition-all p-[20px] xl:p-[35px] rounded-[8px] mb-[30px] group">
                    <img class="self-center mr-[20px] sm:mr-[40px] lg:mr-[20px] xl:mr-[40px] sm:mb-[15px] lg:mb-0"
                        src="{{ asset('frontend/images/icon/phone.png') }}" width="46" height="46" loading="lazy"
                        alt="image icon">
                    <div class="flex-1">
                        <h4
                            class="font-lora group-hover:text-secondary group-hover:transition-all leading-none text-[28px] text-primary mb-[10px]">
                            {{trans('file.contact_us')}}<span class="text-secondary">.</span></h4>
                ...
                <div
                    ...
                    <img class="self-center mr-[20px] sm:mr-[40px] lg:mr-[20px] xl:mr-[40px] sm:mb-[15px] lg:mb-0"
                        src="{{ asset('frontend/images/icon/mail.png') }}" width="46" height="52" loading="lazy"
                        alt="image icon">
                    <div class="flex-1">
                        <h4
                            class="font-lora group-hover:text-secondary group-hover:transition-all leading-none text-[28px] text-primary mb-[10px]">
                            {{trans('file.email_us')}} <span class="text-secondary">.</span></h4>
