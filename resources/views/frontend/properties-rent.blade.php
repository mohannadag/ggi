                            ...
                            <div class="ps-grid__item">
                                <div class="ps-project ps-project--grid">
                                    <div class="ps-project__thumbnail">
                                        <div class="ps-project__image"><img src="{!! $property->photo() !!}" alt="" />
                                        ...
                                        @if ($property->type == 'rent')
                                            <div class="ps-project__badges"><a class="ps-project__badge rent"
                                                    href="javascript:void(0)">{{ trans('file.for_rent') }}</a></div>
                                        @endif
                                    </div>
                                    <div class="ps-project__content">
                                        ...
                                        @if ($property->type == 'rent')
                                            <p>{{ $property->currency->icon }}{{ number_format($property->price) }}<span
                                                    class="ps-project__price"> / {{ trans('file.month') }}</span></p>
                                        @endif
                                        </p>
