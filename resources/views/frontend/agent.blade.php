                ...
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div class="max-w-[700px]  mx-auto text-center text-white relative z-[1]">
                            <div class="mb-5"><span class="text-base block">{{$agent->title}}</span></div>
                            <h1 class="font-lora text-[32px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl font-medium">{{$agent->f_name}} {{$agent->l_name}}</h1>
        ...
        <section class="team-section pt-[80px] lg:pt-[120px]">
            <div class="container">
                <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
                    ...
                    <!--            <span class="font-lora text-secondary text-lg"><span class="counter-up">135</span>-->
                    <!--            <span>k+</span></span>-->
                    <!--            <p>Properties Sold</p>-->
                    <!--        </li>-->
                    <!--        <li class="w-full border-b-[1px] border-[#1B2D40]/60 pb-3 mb-3 md:pb-3 md:mb-3 lg:pb-6 xl:pb-10 lg:mb-6 xl:mb-10">-->
                    <!--            <span class="font-lora text-secondary text-lg"><span class="counter-up">172</span>-->
                    <!--            <span>k+</span></span>-->
                    <!--            <p>Customers</p>-->
                    <!--        </li>-->
                    ...
                    <div class="col-span-12 md:col-span-7 lg:col-span-5 mb-[30px]">
                        <div class="mb-[-30px]">
                            ...
                            <!--    <p>Huge number of propreties availabe here for buy, sell and Rent.-->
                            ...
                            <!--        machine and can serve best service for the clients. </p>-->
                            <!--    <span class="font-lora font-normal block text-secondary text-[18px] mt-[10px]">-->
                            <!--        Phone no. </span>-->
                            <!--    <a href="tel:+9985254784" class="font-lora font-medium text-primary text-[28px]">+9985 254 784</a>-->
                            <!--</div>-->
                        </div>
                        ...
                        <div class="text-center xl:mr-[30px]">
                            <div class="relative rounded-[6px_6px_0px_0px]">
                                <div class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                    <img src="{{ url($agent->photo())}}" class="w-auto h-auto block mx-auto" loading="lazy" alt="{{$agent->f_name}} {{$agent->l_name}}" width="197" height="313">
                                </div>
                            </div>
                            ...
                            <div class="drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] bg-primary transition-all duration-700 border-secondary">
                                <h3 class="font-lora font-normal text-[28px] text-white">{{$agent->f_name}} {{$agent->l_name}}</h3>
                                <p class="font-normal text-[18px] leading-none capitalize mb-[5px] text-white">{{$agent->company_name}}</p>
                                ...
                                <ul class="inline-flex items-center justify-center absolute w-full top-[-30px] left-0">
                                    ...
                                    <li class="ml-[15px]"><a href="{{$agent->fb}}" class="w-[43px] h-[43px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                    ...
                                    <li class="ml-[15px]"><a href="{{$agent->twitter}}" class="w-[43px] h-[43px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                    ...
                                    <li class="ml-[15px]"><a href="{{$agent->instagram}}" class="w-[43px] h-[43px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                ...
                <div class="grid grid-cols-12 gap-x-[30px] xl:gap-x-[55px] mb-[-30px]">
                    ...
                    <div class="col-span-12 lg:col-span-7 mb-[30px]">
                        <h4 class="font-lora text-primary text-[24px] leading-[1.277] sm:text-[28px] capitalize mb-[10px] font-medium">
                            {{trans('file.contact')}} {{$agent->f_name}} {{$agent->l_name}}
                        </h4>
                        ...
                        <!--</p>-->
                        <form id="SubmitForm" class="grid grid-cols-12 gap-x-[20px] gap-y-[30px]">
                        <input type="hidden" name="id" value="{{$agent->id}}" id="InputId">
                            <div class="col-span-12 md:col-span-6">
                                <input class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-[#1B2D40] border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] " type="text" name="name" id="InputName" placeholder="First Name">
                            </div>

                            <div class="col-span-12 md:col-span-6">
                                <input class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-[#1B2D40] border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] " type="text" name="phone" id="InputPhone" placeholder="Phone number">
                            </div>

                            <div class="col-span-12 md:col-span-6">
                                <input class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-[#1B2D40] border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] " type="email" name="email" id="InputEmail" placeholder="Email Address">
                            </div>

                            <div class="col-span-12">
                                <textarea class="h-[196px] font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-[#1B2D40] border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] resize-none" id="message" name="message" cols="30" rows="10" placeholder="Message"></textarea>
                            </div>
            ...
            <div class="container">
                <div class="grid gap-y-[30px] gap-x-[50px]  grid-cols-1 sm:grid-cols-2 md:grid-cols-3  xl:px-[35px]">
                    <div class="relative py-[50px] px-[20px] lg:px-[35px] bg-[#F5F9F8] transition-all drop-shadow-[0px_10px_20px_rgba(0,0,0,0.15)] rounded-[10px]">
                        ...
                        <a href="mailto:{{$agent->email}}" class="font-lora text-base text-primary hover:text-secondary">{{$agent->email}}</a>
                    ...
                    <div class="relative py-[50px] px-[20px] lg:px-[35px] bg-[#F5F9F8] transition-all drop-shadow-[0px_10px_20px_rgba(0,0,0,0.15)] rounded-[10px]">
                        ...
                        <a href="tel:012547987452" class="font-lora text-base text-primary hover:text-secondary">{{$agent->mobile}}</a>
                    ...
                    {{-- <div class="relative py-[50px] px-[20px] lg:px-[35px] bg-[#F5F9F8] transition-all drop-shadow-[0px_10px_20px_rgba(0,0,0,0.15)] rounded-[10px] skew-right">
                        <span class="font-lora text-[28px] leading-none text-secondary mb-[15px] block">instagram.</span>
                        <a href="skype:amelia.margaret" class="font-lora text-base text-primary hover:text-secondary">amelia.margaret</a>
                        <svg class="absolute top-1/2 -translate-y-1/2 right-[30px] instagram" width="90" height="102" viewBox="0 0 90 102" fill="none" xmlns="http://www.w3.org/2000/svg">
