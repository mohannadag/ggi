                            ...
                            <div class="grid sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                ...
                                <div class="swiper-slide">
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                        <div class="relative">
                                            <a href="{{ route('front.property-ivr', ['property' => $property->id]) }}" class="block"><img src="{!! $property->photo() !!}" class="w-full h-full" loading="lazy" width="370" height="266" alt="{{ $property->propertyTranslation->title ?? ($property->propertyTranslationEnglish->title ?? null) }}"></a>
                                        ...
                                        <div class="py-[20px] px-[20px] text-left">
                                            <h3><a href="{{ route('front.property-ivr', ['property' => $property->id]) }}" class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">{{ $property->propertyTranslation->title ?? ($property->propertyTranslationEnglish->title ?? null) }}</a></h3>
                                            <h4><a href="{{ route('front.property-ivr', ['property' => $property->id]) }}" class="font-light text-[14px] leading-[1.75] underline">253 Montril Street, South Town, Miami</a></h4>
                            ...
                            <div class="grid grid-cols-1 gap-[30px]">
                                ...
                                <div class="overflow-hidden rounded-md text-center transition-all duration-300 drop-shadow-[0px_2px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-end">
                                    <div class="relative mb-[15px] lg:mb-[0px] block w-full lg:w-[300px]">
                                        ...
                                        <a href="{{ route('front.property-ivr', ['property' => $property->id]) }}" class="block h-[250px]">
                                    ...
                                    <div class="flex flex-col relative w-full lg:w-[calc(100%-300px)]">
                                        <div class="text-left px-4 lg:px-0 w-full md:w-auto md:flex-1 lg:mr-7 xl:mr-[55px] bg-[#FFFDFC] lg:ml-[30px]">
                                            <h3><a href="{{ route('front.property-ivr', ['property' => $property->id]) }}" class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary font-medium">{{ $property->propertyTranslation->title ?? ($property->propertyTranslationEnglish->title ?? null) }}.</a></h3>
                                            <h4><a href="{{ route('front.property-ivr', ['property' => $property->id]) }}" class="font-light text-tiny underline">
