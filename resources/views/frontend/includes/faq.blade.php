                    ...
                    <div class="grid grid-cols-12 gap-3 sm:gap-[30px] items-center bg-primary z-[-2] lg:pl-[60px] lg:pr-0 lg:py-0 sm:pl-10 sm:pr-10 pl-5 pr-5 py-5 sm:py-12 rounded-[7px]">
                        <div class="col-span-12 lg:col-span-6 relative">
                            <div class="mb-5 lg:mb-0 {{ App::isLocale('ar') ? 'mr-5' : '' }} max-w-[450px]">
                                ...
                                <h2 class="font-lora text-white text-[24px] sm:text-[30px] leading-[1.277] xl:text-xl mb-[10px] font-medium">{{$video->videoTranslation->description}}<span class="text-secondary">.</span>
                                </h2>
                        ...
                        <div class="col-span-12 lg:col-span-6 text-center">
                            <div class="relative rounded-[24px] lg:pt-[45px] lg:pr-[45px] z-[1] lg:inline-block">
                                <div class="">
                                    <img src="{{ asset('frontend/images/video/shape-3.png') }}" class="absolute top-[30px] right-[30px] z-[-1]" loading="lazy" width="50" height="60" alt="{{$video->videoTranslation->name}}">
                                ...
                                <div class="relative lg:-mb-16">
                                    <div class="scene" data-relative-input="true">
                                        <img data-depth="0.1" src="{{asset('/images/images/'.$video->file)}}" class="rounded-[24px] max-w-full" loading="lazy" width="507" height="349" alt="{{$video->videoTranslation->name}}">
                                    </div>
