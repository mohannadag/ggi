            ...
            <div class="container">
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        ...
                        <img width="150px" src="{{ asset('frontend/images/logo/logo.png') }}" loading="lazy" alt="Golden Group Investment logo"> </a>
            ...
            <div class="py-12 pr-5 h-[100vh] overflow-y-auto">
                ...
                <nav class="offcanvas-menu mr-[20px]">
                    <ul>
                        ...
                        <li class="relative block border-b-primary border-b"><a href="#" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5">{{ __(strtoupper(\Illuminate\Support\Facades\Session::get('currentLocal'))) }}</a>
                       ...
                       @endif
                        ...
                        <li class="relative block border-b-primary border-b"><a href="#" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5">{{trans('file.currency')}}</a>
