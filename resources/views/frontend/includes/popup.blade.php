         ...
         <div class="popup-window">
             <div class="window-wrapper">
                 ...
                 <div class="form-side">
                     ...
                     <p class="form-side-contact text-secondary font-karla">{{trans('file.call')}}</p>
                     ...
                     <div class="popup-contact-form-wrapper contact-form text-center p-4 mb-3" id="contact-form-modal">
                         <form class="space-y-6" id="subscribeform">
                             ...
                             <button id="submit" type="submit" class="w-full text-primary bg-secondary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{trans('file.wanthelp')}}</button>
                         </form>
                     </div>
