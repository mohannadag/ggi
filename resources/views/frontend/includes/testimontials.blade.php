                        ...
                        <div class="swiper-slide">
                            ...
                            @endif
                                <div class="inline-block relative bg-primary text-primary rounded-[30px] z-10">
                                    <img src="{{asset('/images/images/'.$testimonial->file)}}" class="w-auto h-auto block mx-auto relative z-[2] thumb" loading="lazy" width="402" height="505" alt="{{$testimonial->name}}">
