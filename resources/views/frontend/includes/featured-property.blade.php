    ...
    <div class="container">
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <span class="text-secondary text-tiny inline-block mb-2">{{trans('file.newly')}}</span>
            </div>
            <div class="col-span-12 flex flex-wrap flex-col md:flex-row items-start justify-between mb-[50px]">
                <div class="mb-5 lg:mb-0">
                    <h2 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium">
                        {{trans('file.recently_added')}}<span class="text-secondary">.</span></h2>
                </div>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    ...
                                    <div class="py-[20px] px-[20px] text-{{ App::isLocale('ar') ? 'right' : 'left' }}">
                                        <h3><a href="{{ route('front.property', ['property' => $property->property_id]) }}"
                                                class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">{{$property->property_id}}</a>
                                        </h3>
                                        <h4><a href="{{ route('front.property', ['property' => $property->property_id]) }}"
                                                ...
                                                {{ $city[$property->city_id]->cityTranslation->name ?? ($city[$property->city_id]->cityTranslationEnglish->name ?? null) }}</a>
                                        </h4>
                                        <span
                                            class="font-light text-sm">{{ $property->category->categoryTranslation->name }}</span>
                                        <ul
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_0px_5px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        ...
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="{{ asset('frontend/images/icon/camera.png') }}" loading="lazy" width="13" height="10" alt="camera icon">{{$property->image->count('property_id')}}</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="{{ asset('frontend/images/icon/video.png') }}" loading="lazy" width="14" height="10" alt="camera icon">01</button>
                                        </div>
