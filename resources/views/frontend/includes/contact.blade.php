                ...
                <div class="mt-[50px]">
                    <form id="contact_form" action="#" class="grid grid-cols-12 gap-x-[20px] gap-y-[30px]">
                        ...
                        <div class="col-span-12 md:col-span-12">
                            <input class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-[#1B2D40] border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] " placeholder="{{trans('file.name')}}" type="text" id="InputName" name="name" value="{{ old('name') }}">
                        </div>
