    ...
    <div class="hero-slider2 overflow-hidden">
        <div class="swiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide bg-cover bg-center bg-sky-100 z-[1] relative before:absolute before:w-full before:h-full before:inset-0 before:content-[''] before:bg-[#000000] before:opacity-[40%] before:z-[-1] py-[80px] lg:py-[200px]" style="background-image: url('{{URL::asset('/images/images/'.$slider->file)}}');">
                    <div class="container">
        ...
        <div class="grid grid-cols-12">
            ...
            <div class="col-span-12 selectricc-border-none">
                <div class="tab-content bg-white border border-solid border-[#016450] border-opacity-25 rounded-bl-[15px] rounded-br-[15px] rounded-tr-[15px] px-[15px] sm:px-[30px] py-[40px] active">
                    <form action="{{ route('search.ivr-property') }}" method="GET">
                        @csrf
                        <div class="advanced-searrch flex flex-wrap items-center -mb-[45px]">
                            ...
                            <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                ...
                                <div class="flex-1">
                                    ...
                                    <select name="city_id" id="city_id" class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer ">
                                        <option value="">{{trans('file.select')}}</option>
