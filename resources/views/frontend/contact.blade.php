...
@include('frontend.includes.header1')
        ...
        <section class="bg-no-repeat bg-center bg-cover bg-[#E9F1FF] h-[350px] lg:h-[513px] flex flex-wrap items-center relative before:absolute before:inset-0 before:content-['']" style="background-image: url('{{asset('frontend/images/breadcrumb/contact-us.jpg')}}');">
            <div class="container">
                ...
                <form id="contact_form">
                    <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px] items-end">
                        <div class="col-span-12 lg:col-span-7 mb-[30px]">
                            <div>
                                <h2 class="font-lora text-primary text-[24px] sm:text-[28px] leading-[1.277] capitalize mb-[10px] font-medium">{{trans('file.contact_us')}}</h2>
                                <p class="max-w-[465px] mb-[40px]">
                                    {{trans('file.contact_desc')}}
                                </p>
                            </div>
                            <div class="grid grid-cols-12 gap-x-[20px] gap-y-[30px]">
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    <input class="font-light w-full leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-secondary focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] phoneInput" placeholder="{{trans('file.phone')}}" name="phone" id="InputPhone" type="tel" name="phone" value="{{ old('phone') }}">
                                </div>
