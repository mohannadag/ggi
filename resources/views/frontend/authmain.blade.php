...
<body class="font-karla text-body text-tiny">
    ...
    <li class="social-media twitter">
        ...
        <a href="{{isset($siteInfo->twitter) ? $siteInfo->twitter : '#'}}" target="_blank">Twitter</a>
    </li>
    <li class="social-media instagram">
        <i class="fab fa-instagram"></i>
        <a href="{{isset($siteInfo->pinterest) ? $siteInfo->pinterest : '#'}}" target="_blank">Instagram</a>
    </li>
    <li class="social-media facebook">
        <i class="fab fa-facebook-f"></i>
        <a href="{{isset($siteInfo->fb) ? $siteInfo->fb : '#'}}" target="_blank">Facebook</a>
    </li>
    <li class="social-media linkedin">
        <i class="fab fa-linkedin-in"></i>
        <a href="{{url('https://www.linkedin.com/company/golden-groupltd')}}" target="_blank">Instagram</a>
    </li>
    </ul>
