                        ...
                        <div class="db-add-listing">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="description" rows="4" placeholder="Enter your text here">{!! old('content') !!}</textarea>
                                    @error('description')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="number" name="Population" class="form-control" id="Population" rows="4" placeholder="Enter your text here">{!! old('Population') !!}</textarea>
                                    @error('Population')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
