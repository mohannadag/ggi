                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control filter-input {{ $errors->has('name') ? 'has-error' : '' }}" placeholder="State Name" @if(isset($cityTranslationEnglish->name)) value="{{$cityTranslationEnglish->name}}" @else value="" @endif>
                                            @if($errors->has('name'))
                                                <span class="help-block text-danger">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Image</label>
                                            <input type="file" class="form-control" name="image" id="photo-upload" enctype="multipart/form-data">
                                            @error('image')
