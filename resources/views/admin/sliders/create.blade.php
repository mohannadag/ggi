                        ...
                        <div class="db-add-listing">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <div class="form-group">
                                        <label for="">File:(image/video)</label> <span class="text-danger">*</span>
                                        <input type="file" name="mobile_file" class="form-control" id="photo-upload">
                                        @error('file')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="button_text" class="form-control filter-input" placeholder="Button Title" value="{{ old('button_text') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
